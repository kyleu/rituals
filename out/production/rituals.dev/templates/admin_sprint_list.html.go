...
// source: github.com/kyleu/rituals.dev/web/templates/admin/sprint/list.html
// DO NOT EDIT!
package templates
...
func AdminSprintList(sprints sprint.Sessions, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
