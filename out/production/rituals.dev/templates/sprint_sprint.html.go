...
// source: github.com/kyleu/rituals.dev/web/templates/sprint/sprint.html
// DO NOT EDIT!
package templates
...
func SprintWorkspace(model *sprint.Session, auths auth.Records, ctx web.RequestContext, w io.Writer) (int, error) {
  ...
  <div class="uk-container">
    <div class="uk-grid-match uk-grid-small" data-uk-grid>
      <div class="uk-width-2-3@m">
        `)
	SprintSession(model, auths, ctx, _buffer)
	...
	_buffer.WriteString(`
      ...
      <div class="uk-width-2-3@m">
        `)
	SprintContents(model, ctx, _buffer)
	_buffer.WriteString(`
      </div>
      <div class="uk-width-1-3@m">
        `)
...
`)
	ComponentSessionWelcome(util.SvcSprint, ctx, _buffer)
	ComponentSessionComments(ctx, _buffer)
	_buffer.WriteString(`
<script>window.addEventListener("load", function() { rituals.init(services.sprint.key, "`)
