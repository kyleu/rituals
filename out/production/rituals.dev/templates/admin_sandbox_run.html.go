...
// source: github.com/kyleu/rituals.dev/web/templates/admin/sandbox/run.html
// DO NOT EDIT!
package templates
...
func AdminSandboxRun(sb *sandbox.Sandbox, content string, ctx web.RequestContext, w io.Writer) (int, error) {
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
	...
	hero.EscapeHTML(sb.Title, _buffer)
	_buffer.WriteString(`</h3>
      <div class="uk-margin-top">
        `)
	if sb.Key == "gallery" {
		AdminSandboxGallery(ctx, _buffer)
	} else {
		_buffer.WriteString(`
          <pre>`)
		hero.EscapeHTML(content, _buffer)
