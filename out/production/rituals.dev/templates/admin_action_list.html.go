...
// source: github.com/kyleu/rituals.dev/web/templates/admin/action/list.html
// DO NOT EDIT!
package templates
...
func AdminActionList(actions action.Actions, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
    <div class="uk-card uk-card-body">
      <h3 class="uk-card-title">App Actions</h3>
      `)
