...
// source: github.com/kyleu/rituals.dev/web/templates/admin/connection/list.html
// DO NOT EDIT!
package templates
...
func AdminConnectionList(connections socket.Statuses, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
    <div class="uk-card uk-card-body">
      ...
      `)
	AdminConnectionTable(connections, params.Get(util.KeyConnection, ctx.Logger), ctx, _buffer)
	_buffer.WriteString(`
    </div>
  </div>
</div>
