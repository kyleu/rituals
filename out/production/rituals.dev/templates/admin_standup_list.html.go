...
// source: github.com/kyleu/rituals.dev/web/templates/admin/standup/list.html
// DO NOT EDIT!
package templates
...
func AdminStandupList(standups standup.Sessions, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
