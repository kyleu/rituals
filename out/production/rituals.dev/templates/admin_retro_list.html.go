...
// source: github.com/kyleu/rituals.dev/web/templates/admin/retro/list.html
// DO NOT EDIT!
package templates
...
func AdminRetroList(retros retro.Sessions, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
