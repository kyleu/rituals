...
// source: github.com/kyleu/rituals.dev/web/templates/admin/estimate/list.html
// DO NOT EDIT!
package templates
...
func AdminEstimateList(estimates estimate.Sessions, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
