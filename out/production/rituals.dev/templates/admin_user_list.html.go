...
// source: github.com/kyleu/rituals.dev/web/templates/admin/user/list.html
// DO NOT EDIT!
package templates
...
func AdminUserList(users user.SystemUsers, params query.ParamSet, ctx web.RequestContext, w io.Writer) (int, error) {
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
    <div class="uk-card uk-card-body">
      <h3 class="uk-card-title">System Users</h3>
      `)
	AdminUserTable(users, params.Get(util.SvcEstimate.Key, ctx.Logger), ctx, _buffer)
	_buffer.WriteString(`
    </div>
  </div>
</div>
