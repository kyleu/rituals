...
// source: github.com/kyleu/rituals.dev/web/templates/admin/sandbox/gallery.html
// DO NOT EDIT!
package templates
...
func AdminSandboxGallery(ctx web.RequestContext, buffer *bytes.Buffer) {
	buffer.WriteString(`
              ...
              <header class="uk-comment-header uk-position-relative">
                <div class="uk-grid-medium uk-flex-middle" uk-grid>
                  <div class="uk-width-auto">
                    <img class="uk-comment-avatar" src="https://placekitten.com/50/50" width="50" alt="">
                  </div>
    ...
    <div class="uk-grid-divider uk-child-width-auto@m" uk-grid>
      ...
      <div>
        ...
        <ul class="uk-thumbnav">
          <li class="uk-active"><a href="#"><img src="https://placekitten.com/60/60" width="60" alt=""></a></li>
          <li><a href="#"><img src="https://placekitten.com/60/60" width="60" alt=""></a></li>
          <li><a href="#"><img src="https://placekitten.com/60/60" width="60" alt=""></a></li>
        </ul>
