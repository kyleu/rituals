...
// source: github.com/kyleu/rituals.dev/web/templates/graphql/graphiql.html
// DO NOT EDIT!
package templates
...
`)
	...
	_buffer.WriteString(`
  <div id="`)
	hero.EscapeHTML(util.KeyGraphiQL, _buffer)
  ...
  <script>
	...
	_buffer.WriteString(` profile-link uk-icon-link",
	...
	hero.EscapeHTML(ctx.Route(util.AdminLink(util.KeyVoyager, `query`)), _buffer)
	_buffer.WriteString(`");
      var s = React.createElement("span", { style: { display: "inline-block", width: "16px" } });
      var m = voyagerLink("mutation", "cog", "`)
	hero.EscapeHTML(ctx.Route(util.AdminLink(util.KeyVoyager, `mutation`)), _buffer)
	_buffer.WriteString(`");
      ReactDOM.render(
  ...
  `)
	if ctx.Profile.Theme == util.ThemeDark {
		_buffer.WriteString(`
  <style>
