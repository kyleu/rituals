...
// source: github.com/kyleu/rituals.dev/web/templates/standup/list.html
// DO NOT EDIT!
package templates
...
func StandupList(sessions standup.Sessions, teams team.Sessions, sprints sprint.Sessions, auths auth.Records, params *query.Params, ctx web.RequestContext, w io.Writer) (int, error) {
...
<div class="uk-section uk-section-small">
  <div class="uk-container">
	...
	hero.EscapeHTML(util.SvcStandup.Icon, _buffer)
	_buffer.WriteString(`"></span> `)
	hero.EscapeHTML(util.SvcStandup.PluralTitle, _buffer)
	_buffer.WriteString(`</h3>
      <p>Share your progress with your team</p>
      `)
	if len(sessions) > 0 {
		StandupTable(sessions, params, ctx, _buffer)
	}
	_buffer.WriteString(`
    </div>

    <div class="uk-card uk-card-body uk-margin-top">
      <h3 class="uk-card-title">New Standup</h3>
      <form class="uk-form-stacked" action="`)
	hero.EscapeHTML(ctx.Route(util.SvcStandup.Key+`.new`), _buffer)
	_buffer.WriteString(`" method="post">
        `)
	StandupForm("", teams, sprints, auths, ctx, _buffer)
	_buffer.WriteString(`
