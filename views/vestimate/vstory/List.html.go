...
`)
//line views/vestimate/vstory/List.html:26
	if len(p.Models) > 0 {
//line views/vestimate/vstory/List.html:26
...
`)
//line views/vestimate/vstory/List.html:37
	} else {
//line views/vestimate/vstory/List.html:37
		qw422016.N().S(`    <div class="overflow clear mt">
      `)
//line views/vestimate/vstory/List.html:39
		StreamTable(qw422016, p.Models, p.EstimatesByEstimateID, p.UsersByUserID, p.Params, as, ps)
//line views/vestimate/vstory/List.html:39
		qw422016.N().S(`
    </div>
`)
//line views/vestimate/vstory/List.html:41
	}
//line views/vestimate/vstory/List.html:41
	qw422016.N().S(`  </div>
`)
//line views/vestimate/vstory/List.html:43
}
