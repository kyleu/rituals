...
//line views/vestimate/vstory/vvote/Edit.html:20
    ...
    <form action="/admin/db/estimate/story/vote/_new" class="mt" method="post">
`)
...
//line views/vestimate/vstory/vvote/Edit.html:29
	if p.IsNew {
//line views/vestimate/vstory/vvote/Edit.html:29
		components.StreamTableInputUUID(qw422016, "storyID", "input-storyID", "Story ID", &p.Model.StoryID, 5, "UUID in format (00000000-0000-0000-0000-000000000000)")
//line views/vestimate/vstory/vvote/Edit.html:29
	}
//line views/vestimate/vstory/vvote/Edit.html:29
	qw422016.N().S(`
