...
//line views/vestimate/vehistory/Detail.html:17
func (p *Detail) StreamBody(qw422016 *qt422016.Writer, as *app.State, ps *cutil.PageState) {
//line views/vestimate/vehistory/Detail.html:17
	qw422016.N().S(`
  <div class="card">
    <div class="right">
      <a href="#modal-estimateHistory"><button type="button">JSON</button></a>
      <a href="`)
...
//line views/vestimate/vehistory/Detail.html:21
    ...
    <h3>`)
//line views/vestimate/vehistory/Detail.html:23
...
//line views/vestimate/vehistory/Detail.html:23
	qw422016.N().S(`</h3>
    <div><a href="/estimate/ehistory"><em>History</em></a></div>
    <table class="mt">
      <tbody>
        <tr>
...
//line views/vestimate/vehistory/Detail.html:29
	qw422016.N().S(`</td>
        ...
        <tr>
          ...
          <td>
            <div class="icon">`)
//line views/vestimate/vehistory/Detail.html:34
...
//line views/vestimate/vehistory/Detail.html:35
	qw422016.N().S(`</a>
        ...
        <tr>
          ...
          <td>`)
//line views/vestimate/vehistory/Detail.html:40
	qw422016.E().S(p.Model.EstimateName)
//line views/vestimate/vehistory/Detail.html:40
	qw422016.N().S(`</td>
        </tr>
        <tr>
