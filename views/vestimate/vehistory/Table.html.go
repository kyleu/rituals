...
//line views/vestimate/vehistory/Table.html:11
func StreamTableRow(qw422016 *qt422016.Writer, model *ehistory.EstimateHistory, estimatesByEstimateID estimate.Estimates, ps *cutil.PageState, paths ...string) {
//line views/vestimate/vehistory/Table.html:11
	qw422016.N().S(`
  <tr>
    <td><a href="`)
...
//line views/vestimate/vehistory/Table.html:13
    ...
    <td class="nowrap">
      `)
//line views/vestimate/vehistory/Table.html:15
...
//line views/vestimate/vehistory/Table.html:19
    ...
    <td>`)
//line views/vestimate/vehistory/Table.html:21
	view.StreamString(qw422016, model.EstimateName)
//line views/vestimate/vehistory/Table.html:21
	qw422016.N().S(`</td>
    <td>`)
//line views/vestimate/vehistory/Table.html:22
...
//line views/vestimate/vehistory/Table.html:24
func WriteTableRow(qq422016 qtio422016.Writer, model *ehistory.EstimateHistory, estimatesByEstimateID estimate.Estimates, ps *cutil.PageState, paths ...string) {
//line views/vestimate/vehistory/Table.html:24
...
//line views/vestimate/vehistory/Table.html:24
func TableRow(model *ehistory.EstimateHistory, estimatesByEstimateID estimate.Estimates, ps *cutil.PageState, paths ...string) string {
//line views/vestimate/vehistory/Table.html:24
...
`)
//line views/vestimate/vehistory/Table.html:45
	if prms.HasNextPage(len(models)+prms.Offset) || prms.HasPreviousPage() {
//line views/vestimate/vehistory/Table.html:45
		qw422016.N().S(`  <hr />
  `)
//line views/vestimate/vehistory/Table.html:47
		components.StreamPagination(qw422016, len(models)+prms.Offset, prms, ps.URI)
//line views/vestimate/vehistory/Table.html:47
		qw422016.N().S(`
  <div class="clear"></div>
`)
//line views/vestimate/vehistory/Table.html:49
	}
//line views/vestimate/vehistory/Table.html:50
}
