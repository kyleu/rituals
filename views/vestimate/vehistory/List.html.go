...
//line views/vestimate/vehistory/List.html:2
package vehistory
...
//line views/vestimate/vehistory/List.html:12
import (
	qtio422016 "io"
...
//line views/vestimate/vehistory/List.html:19
...
//line views/vestimate/vehistory/List.html:25
	qw422016.N().S(`</h3>
`)
//line views/vestimate/vehistory/List.html:26
	if len(p.Models) == 0 {
//line views/vestimate/vehistory/List.html:26
		qw422016.N().S(`    <div class="mt"><em>No histories available</em></div>
`)
//line views/vestimate/vehistory/List.html:28
	} else {
//line views/vestimate/vehistory/List.html:28
		qw422016.N().S(`    <div class="mt">
      `)
//line views/vestimate/vehistory/List.html:30
		StreamTable(qw422016, p.Models, p.EstimatesByEstimateID, p.Params, as, ps)
//line views/vestimate/vehistory/List.html:30
		qw422016.N().S(`
    </div>
`)
//line views/vestimate/vehistory/List.html:32
	}
//line views/vestimate/vehistory/List.html:32
	qw422016.N().S(`  </div>
`)
//line views/vestimate/vehistory/List.html:34
}
