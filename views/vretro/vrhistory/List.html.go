...
//line views/vretro/vrhistory/List.html:25
	qw422016.N().S(`</h3>
`)
//line views/vretro/vrhistory/List.html:26
	if len(p.Models) == 0 {
//line views/vretro/vrhistory/List.html:26
		qw422016.N().S(`    <div class="mt"><em>No histories available</em></div>
`)
//line views/vretro/vrhistory/List.html:28
	} else {
//line views/vretro/vrhistory/List.html:28
		qw422016.N().S(`    <div class="mt">
      `)
//line views/vretro/vrhistory/List.html:30
		StreamTable(qw422016, p.Models, p.RetrosByRetroID, p.Params, as, ps)
//line views/vretro/vrhistory/List.html:30
		qw422016.N().S(`
    </div>
`)
//line views/vretro/vrhistory/List.html:32
	}
//line views/vretro/vrhistory/List.html:32
	qw422016.N().S(`  </div>
`)
//line views/vretro/vrhistory/List.html:34
}
