...
//line views/vretro/vrmember/Detail.html:1
package vrmember
...
//line views/vretro/vrmember/Detail.html:13
import (
	qtio422016 "io"
...
//line views/vretro/vrmember/Detail.html:21
func (p *Detail) StreamBody(qw422016 *qt422016.Writer, as *app.State, ps *cutil.PageState) {
//line views/vretro/vrmember/Detail.html:21
	qw422016.N().S(`
  <div class="card">
    <div class="right">
      <a href="#modal-retroMember"><button type="button" title="JSON">`)
...
//line views/vretro/vrmember/Detail.html:27
	qw422016.N().S(`</h3>
    <div><a href="`)
//line views/vretro/vrmember/Detail.html:28
	qw422016.E().S(rmember.Route(p.Paths...))
//line views/vretro/vrmember/Detail.html:28
	qw422016.N().S(`"><em>Member</em></a></div>
    `)
//line views/vretro/vrmember/Detail.html:29
...
//line views/vretro/vrmember/Detail.html:33
	qw422016.N().S(`
`)
//line views/vretro/vrmember/Detail.html:34
}
...
//line views/vretro/vrmember/Detail.html:44
	qw422016.N().S(`</a>
        ...
        <tr>
          ...
          <td class="nowrap">
            `)
//line views/vretro/vrmember/Detail.html:50
...
//line views/vretro/vrmember/Detail.html:50
	qw422016.N().S(`
            <a title="User" href="`)
//line views/vretro/vrmember/Detail.html:51
...
//line views/vretro/vrmember/Detail.html:56
	qw422016.N().S(`</strong></td>
        ...
        <tr>
          ...
          <td><a href="`)
//line views/vretro/vrmember/Detail.html:60
...
//line views/vretro/vrmember/Detail.html:63
	qw422016.E().S(enum.AllMemberStatuses.Help())
//line views/vretro/vrmember/Detail.html:63
	qw422016.N().S(`">Role</th>
          <td>`)
//line views/vretro/vrmember/Detail.html:64
...
//line views/vretro/vrmember/Detail.html:68
	qw422016.N().S(`</td>
        ...
        <tr>
          ...
          <td>`)
//line views/vretro/vrmember/Detail.html:72
...
`)
//line views/vretro/vrmember/Detail.html:77
}
