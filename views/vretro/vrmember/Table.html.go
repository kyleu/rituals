...
//line views/vretro/vrmember/Table.html:12
import (
	qtio422016 "io"
...
//line views/vretro/vrmember/Table.html:12
func StreamTable(qw422016 *qt422016.Writer, models rmember.RetroMembers, retros retro.Retros, users user.Users, params filter.ParamSet, as *app.State, ps *cutil.PageState) {
//line views/vretro/vrmember/Table.html:12
	qw422016.N().S(`
`)
...
//line views/vretro/vrmember/Table.html:21
	components.StreamTableHeaderSimple(qw422016, "rmember", "role", "Role", "Available options: [owner, member, observer]", prms, ps.URI, ps)
//line views/vretro/vrmember/Table.html:21
	qw422016.N().S(`
        `)
...
//line views/vretro/vrmember/Table.html:51
func WriteTable(qq422016 qtio422016.Writer, models rmember.RetroMembers, retros retro.Retros, users user.Users, params filter.ParamSet, as *app.State, ps *cutil.PageState) {
//line views/vretro/vrmember/Table.html:51
...
//line views/vretro/vrmember/Table.html:51
func Table(models rmember.RetroMembers, retros retro.Retros, users user.Users, params filter.ParamSet, as *app.State, ps *cutil.PageState) string {
//line views/vretro/vrmember/Table.html:51
