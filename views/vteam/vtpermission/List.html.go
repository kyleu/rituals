...
//line views/vteam/vtpermission/List.html:18
...
`)
//line views/vteam/vtpermission/List.html:21
	if len(p.Models) > 1 {
//line views/vteam/vtpermission/List.html:21
...
//line views/vteam/vtpermission/List.html:21
	qw422016.N().S(`      <a href="/admin/db/team/permission/_new"><button>`)
...
//line views/vteam/vtpermission/List.html:22
    ...
    <h3>`)
//line views/vteam/vtpermission/List.html:24
...
//line views/vteam/vtpermission/List.html:27
      ...
      `)
//line views/vteam/vtpermission/List.html:29
		StreamTable(qw422016, p.Models, p.TeamsByTeamID, p.Params, as, ps)
//line views/vteam/vtpermission/List.html:29
		qw422016.N().S(`
    </div>
`)
//line views/vteam/vtpermission/List.html:31
	}
//line views/vteam/vtpermission/List.html:31
	qw422016.N().S(`  </div>
`)
//line views/vteam/vtpermission/List.html:33
}
