...
//line views/vteam/vtmember/Edit.html:28
	qw422016.E().S(util.Choose(p.IsNew, tmember.Route(p.Paths...)+`/_new`, p.Model.WebPath(p.Paths...)+`/edit`))
//line views/vteam/vtmember/Edit.html:28
...
`)
//line views/vteam/vtmember/Edit.html:47
}
