...
//line views/vworkspace/StandupList.html:1
package vworkspace
...
//line views/vworkspace/StandupList.html:14
import (
	qtio422016 "io"
...
//line views/vworkspace/StandupList.html:23
    ...
    <table class="mt expanded">
      <tbody>
`)
//line views/vworkspace/StandupList.html:27
	for _, u := range p.Standups {
//line views/vworkspace/StandupList.html:27
		qw422016.N().S(`        <tr>
          <td><a href="/standup/`)
//line views/vworkspace/StandupList.html:29
		qw422016.E().S(u.Slug)
//line views/vworkspace/StandupList.html:29
		qw422016.N().S(`">`)
//line views/vworkspace/StandupList.html:29
...
//line views/vworkspace/StandupList.html:30
		components.StreamDisplayTimestamp(qw422016, &u.Created)
//line views/vworkspace/StandupList.html:30
		qw422016.N().S(`</td>
        </tr>
`)
//line views/vworkspace/StandupList.html:32
	}
//line views/vworkspace/StandupList.html:32
	qw422016.N().S(`      </tbody>
    </table>
  ...
  <div class="card">
    <h3>`)
//line views/vworkspace/StandupList.html:37
	components.StreamSVGRefIcon(qw422016, `standup`, ps)
//line views/vworkspace/StandupList.html:37
	qw422016.N().S(`New Standup</h3>
    `)
//line views/vworkspace/StandupList.html:38
	StreamStandupForm(qw422016, &standup.Standup{}, p.Teams, p.Sprints, as, ps)
//line views/vworkspace/StandupList.html:38
	qw422016.N().S(`
  </div>
`)
//line views/vworkspace/StandupList.html:40
}
...
//line views/vworkspace/StandupList.html:42
...
//line views/vworkspace/StandupList.html:42
  ...
  <form action="" method="post">
    <table class="mt expanded">
      <tbody>
        `)
//line views/vworkspace/StandupList.html:46
	components.StreamTableInput(qw422016, "title", "Team Title", s.Title, 5, "The name of your standup")
//line views/vworkspace/StandupList.html:46
	qw422016.N().S(`
        `)
//line views/vworkspace/StandupList.html:47
	components.StreamTableInput(qw422016, "owner", "Your Name", ps.Profile.Name, 5, "Whatever you prefer to be called")
//line views/vworkspace/StandupList.html:47
	qw422016.N().S(`
        `)
//line views/vworkspace/StandupList.html:48
	components.StreamTableSelect(qw422016, "team", "Team", fmt.Sprint(s.TeamID), teams.IDStrings(true), teams.TitleStrings("- no team -"), 5, "The team associated to this standup")
//line views/vworkspace/StandupList.html:48
	qw422016.N().S(`
        `)
//line views/vworkspace/StandupList.html:49
	components.StreamTableSelect(qw422016, "sprint", "Sprint", fmt.Sprint(s.SprintID), sprints.IDStrings(true), sprints.TitleStrings("- no sprint -"), 5, "The sprint associated to this standup")
//line views/vworkspace/StandupList.html:49
	qw422016.N().S(`
...
`)
//line views/vworkspace/StandupList.html:54
}
