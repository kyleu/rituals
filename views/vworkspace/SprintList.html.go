...
//line views/vworkspace/SprintList.html:1
package vworkspace
...
//line views/vworkspace/SprintList.html:13
import (
	qtio422016 "io"
...
//line views/vworkspace/SprintList.html:21
    ...
    <table class="mt expanded">
      <tbody>
`)
//line views/vworkspace/SprintList.html:25
	for _, s := range p.Sprints {
//line views/vworkspace/SprintList.html:25
		qw422016.N().S(`        <tr>
          <td><a href="/sprint/`)
//line views/vworkspace/SprintList.html:27
		qw422016.E().S(s.Slug)
//line views/vworkspace/SprintList.html:27
		qw422016.N().S(`">`)
//line views/vworkspace/SprintList.html:27
...
//line views/vworkspace/SprintList.html:28
		components.StreamDisplayTimestamp(qw422016, &s.Created)
//line views/vworkspace/SprintList.html:28
		qw422016.N().S(`</td>
        </tr>
`)
//line views/vworkspace/SprintList.html:30
	}
//line views/vworkspace/SprintList.html:30
	qw422016.N().S(`      </tbody>
    </table>
  ...
  <div class="card">
    <h3>`)
//line views/vworkspace/SprintList.html:35
	components.StreamSVGRefIcon(qw422016, `sprint`, ps)
//line views/vworkspace/SprintList.html:35
	qw422016.N().S(`New Sprint</h3>
    `)
//line views/vworkspace/SprintList.html:36
	StreamSprintForm(qw422016, &sprint.Sprint{}, p.Teams, as, ps)
//line views/vworkspace/SprintList.html:36
	qw422016.N().S(`
  </div>
`)
//line views/vworkspace/SprintList.html:38
}
...
//line views/vworkspace/SprintList.html:40
...
//line views/vworkspace/SprintList.html:40
  ...
  <form action="" method="post">
    <table class="mt expanded">
      <tbody>
        `)
//line views/vworkspace/SprintList.html:44
	components.StreamTableInput(qw422016, "title", "Team Title", s.Title, 5, "The name of your sprint")
//line views/vworkspace/SprintList.html:44
	qw422016.N().S(`
        `)
//line views/vworkspace/SprintList.html:45
	components.StreamTableInput(qw422016, "owner", "Your Name", ps.Profile.Name, 5, "Whatever you prefer to be called")
//line views/vworkspace/SprintList.html:45
	qw422016.N().S(`
        `)
//line views/vworkspace/SprintList.html:46
	components.StreamTableSelect(qw422016, "team", "Team", fmt.Sprint(s.TeamID), teams.IDStrings(true), teams.TitleStrings("- no team -"), 5, "The team associated to this sprint")
//line views/vworkspace/SprintList.html:46
	qw422016.N().S(`
...
`)
//line views/vworkspace/SprintList.html:51
}
