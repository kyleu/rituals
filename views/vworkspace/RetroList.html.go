...
//line views/vworkspace/RetroList.html:1
package vworkspace
...
//line views/vworkspace/RetroList.html:14
import (
	qtio422016 "io"
...
//line views/vworkspace/RetroList.html:23
    ...
    <table class="mt expanded">
      <tbody>
`)
//line views/vworkspace/RetroList.html:27
	for _, r := range p.Retros {
//line views/vworkspace/RetroList.html:27
		qw422016.N().S(`        <tr>
          <td><a href="/retro/`)
//line views/vworkspace/RetroList.html:29
		qw422016.E().S(r.Slug)
//line views/vworkspace/RetroList.html:29
		qw422016.N().S(`">`)
//line views/vworkspace/RetroList.html:29
...
//line views/vworkspace/RetroList.html:30
		components.StreamDisplayTimestamp(qw422016, &r.Created)
//line views/vworkspace/RetroList.html:30
		qw422016.N().S(`</td>
        </tr>
`)
//line views/vworkspace/RetroList.html:32
	}
//line views/vworkspace/RetroList.html:32
	qw422016.N().S(`      </tbody>
    </table>
  ...
  <div class="card">
    <h3>`)
//line views/vworkspace/RetroList.html:37
	components.StreamSVGRefIcon(qw422016, `retro`, ps)
//line views/vworkspace/RetroList.html:37
	qw422016.N().S(`New Retro</h3>
    `)
//line views/vworkspace/RetroList.html:38
	StreamRetroForm(qw422016, &retro.Retro{}, p.Teams, p.Sprints, as, ps)
//line views/vworkspace/RetroList.html:38
	qw422016.N().S(`
  </div>
`)
//line views/vworkspace/RetroList.html:40
}
...
//line views/vworkspace/RetroList.html:42
...
//line views/vworkspace/RetroList.html:42
  ...
  <form action="" method="post">
    <table class="mt expanded">
      <tbody>
        `)
//line views/vworkspace/RetroList.html:46
	components.StreamTableInput(qw422016, "title", "Team Title", s.Title, 5, "The name of your retro")
//line views/vworkspace/RetroList.html:46
	qw422016.N().S(`
        `)
//line views/vworkspace/RetroList.html:47
	components.StreamTableInput(qw422016, "name", "Your Name", ps.Profile.Name, 5, "Whatever you prefer to be called")
//line views/vworkspace/RetroList.html:47
	qw422016.N().S(`
        `)
//line views/vworkspace/RetroList.html:48
	components.StreamTableSelect(qw422016, "team", "Team", fmt.Sprint(s.TeamID), teams.IDStrings(true), teams.TitleStrings("- no team -"), 5, "The team associated to this retro")
//line views/vworkspace/RetroList.html:48
	qw422016.N().S(`
        `)
//line views/vworkspace/RetroList.html:49
	components.StreamTableSelect(qw422016, "sprint", "Sprint", fmt.Sprint(s.SprintID), sprints.IDStrings(true), sprints.TitleStrings("- no sprint -"), 5, "The sprint associated to this retro")
//line views/vworkspace/RetroList.html:49
	qw422016.N().S(`
...
`)
//line views/vworkspace/RetroList.html:54
}
