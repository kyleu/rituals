...
//line views/vstandup/List.html:13
import (
	qtio422016 "io"
...
//line views/vstandup/List.html:22
...
`)
//line views/vstandup/List.html:37
	} else {
//line views/vstandup/List.html:37
		qw422016.N().S(`    <div class="overflow clear mt">
      `)
//line views/vstandup/List.html:39
		StreamTable(qw422016, p.Models, p.TeamsByTeamID, p.SprintsBySprintID, p.Params, as, ps)
//line views/vstandup/List.html:39
		qw422016.N().S(`
    </div>
`)
//line views/vstandup/List.html:41
	}
//line views/vstandup/List.html:41
	qw422016.N().S(`  </div>
`)
//line views/vstandup/List.html:43
}
