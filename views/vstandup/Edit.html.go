...
//line views/vstandup/Edit.html:28
	qw422016.E().S(util.Choose(p.IsNew, standup.Route(p.Paths...)+`/_new`, p.Model.WebPath(p.Paths...)+`/edit`))
//line views/vstandup/Edit.html:28
...
//line views/vstandup/Edit.html:36
	qw422016.N().S(`
          `)
//line views/vstandup/Edit.html:37
