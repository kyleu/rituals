...
//line views/vstandup/vreport/Table.html:12
func StreamTableRow(qw422016 *qt422016.Writer, model *report.Report, standupsByStandupID standup.Standups, usersByUserID user.Users, ps *cutil.PageState, paths ...string) {
//line views/vstandup/vreport/Table.html:12
	qw422016.N().S(`
  <tr>
    <td><a href="`)
...
//line views/vstandup/vreport/Table.html:14
    ...
    <td class="nowrap">
      `)
//line views/vstandup/vreport/Table.html:16
...
//line views/vstandup/vreport/Table.html:24
		qw422016.N().S(`
      `)
//line views/vstandup/vreport/Table.html:25
		qw422016.E().S(x.TitleString())
//line views/vstandup/vreport/Table.html:25
...
//line views/vstandup/vreport/Table.html:25
		qw422016.N().S(`</a>
      `)
//line views/vstandup/vreport/Table.html:26
	} else {
//line views/vstandup/vreport/Table.html:26
		qw422016.N().S(`
      `)
...
//line views/vstandup/vreport/Table.html:34
func WriteTableRow(qq422016 qtio422016.Writer, model *report.Report, standupsByStandupID standup.Standups, usersByUserID user.Users, ps *cutil.PageState, paths ...string) {
//line views/vstandup/vreport/Table.html:34
...
//line views/vstandup/vreport/Table.html:34
func TableRow(model *report.Report, standupsByStandupID standup.Standups, usersByUserID user.Users, ps *cutil.PageState, paths ...string) string {
//line views/vstandup/vreport/Table.html:34
...
//line views/vstandup/vreport/Table.html:58
		qw422016.N().S(`  <hr />
  `)
//line views/vstandup/vreport/Table.html:60
		components.StreamPagination(qw422016, len(models)+prms.Offset, prms, ps.URI)
//line views/vstandup/vreport/Table.html:60
		qw422016.N().S(`
  <div class="clear"></div>
`)
//line views/vstandup/vreport/Table.html:62
	}
//line views/vstandup/vreport/Table.html:63
}
