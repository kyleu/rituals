...
//line views/vstandup/vuhistory/Detail.html:17
  ...
  <div class="card">
    <div class="right">
      <a href="#modal-standupHistory"><button type="button">JSON</button></a>
      <a href="`)
...
//line views/vstandup/vuhistory/Detail.html:23
	qw422016.N().S(`</h3>
    <div><a href="/standup/uhistory"><em>History</em></a></div>
    <table class="mt">
      <tbody>
        <tr>
...
//line views/vstandup/vuhistory/Detail.html:35
	qw422016.N().S(`</a>
        ...
        <tr>
          ...
          <td>`)
//line views/vstandup/vuhistory/Detail.html:40
	qw422016.E().S(p.Model.StandupName)
//line views/vstandup/vuhistory/Detail.html:40
	qw422016.N().S(`</td>
        </tr>
        <tr>
...
//line views/vstandup/vuhistory/Detail.html:50
	qw422016.N().S(`  `)
//line views/vstandup/vuhistory/Detail.html:51
