...
//line views/vsprint/vspermission/List.html:25
	qw422016.N().S(`</h3>
`)
//line views/vsprint/vspermission/List.html:26
	if len(p.Models) == 0 {
//line views/vsprint/vspermission/List.html:26
		qw422016.N().S(`    <div class="mt"><em>No permissions available</em></div>
`)
//line views/vsprint/vspermission/List.html:28
	} else {
//line views/vsprint/vspermission/List.html:28
		qw422016.N().S(`    <div class="mt">
      `)
//line views/vsprint/vspermission/List.html:30
		StreamTable(qw422016, p.Models, p.SprintsBySprintID, p.Params, as, ps, p.Paths...)
//line views/vsprint/vspermission/List.html:30
		qw422016.N().S(`
    </div>
`)
//line views/vsprint/vspermission/List.html:32
	}
//line views/vsprint/vspermission/List.html:32
	qw422016.N().S(`  </div>
`)
//line views/vsprint/vspermission/List.html:34
}
