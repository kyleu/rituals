...
//line views/vsprint/vsmember/Table.html:13
func StreamTableRow(qw422016 *qt422016.Writer, model *smember.SprintMember, sprintsBySprintID sprint.Sprints, usersByUserID user.Users, ps *cutil.PageState, paths ...string) {
//line views/vsprint/vsmember/Table.html:13
	qw422016.N().S(`
  <tr>
    <td class="nowrap">
      `)
//line views/vsprint/vsmember/Table.html:16
...
//line views/vsprint/vsmember/Table.html:25
		qw422016.N().S(`
      <a href="`)
//line views/vsprint/vsmember/Table.html:26
		qw422016.E().S(model.WebPath())
//line views/vsprint/vsmember/Table.html:26
		qw422016.N().S(`">`)
//line views/vsprint/vsmember/Table.html:26
...
//line views/vsprint/vsmember/Table.html:35
func WriteTableRow(qq422016 qtio422016.Writer, model *smember.SprintMember, sprintsBySprintID sprint.Sprints, usersByUserID user.Users, ps *cutil.PageState, paths ...string) {
//line views/vsprint/vsmember/Table.html:35
	qw422016 := qt422016.AcquireWriter(qq422016)
//line views/vsprint/vsmember/Table.html:35
	StreamTableRow(qw422016, model, sprintsBySprintID, usersByUserID, ps, paths...)
//line views/vsprint/vsmember/Table.html:35
...
//line views/vsprint/vsmember/Table.html:35
func TableRow(model *smember.SprintMember, sprintsBySprintID sprint.Sprints, usersByUserID user.Users, ps *cutil.PageState, paths ...string) string {
//line views/vsprint/vsmember/Table.html:35
	qb422016 := qt422016.AcquireByteBuffer()
//line views/vsprint/vsmember/Table.html:35
	WriteTableRow(qb422016, model, sprintsBySprintID, usersByUserID, ps, paths...)
//line views/vsprint/vsmember/Table.html:35
...
//line views/vsprint/vsmember/Table.html:54
		StreamTableRow(qw422016, model, sprintsBySprintID, usersByUserID, ps, paths...)
//line views/vsprint/vsmember/Table.html:55
	}
//line views/vsprint/vsmember/Table.html:55
	qw422016.N().S(`      </tbody>
    </table>
...
`)
//line views/vsprint/vsmember/Table.html:59
	if prms.HasNextPage(len(models)+prms.Offset) || prms.HasPreviousPage() {
//line views/vsprint/vsmember/Table.html:59
		qw422016.N().S(`  <hr />
  `)
//line views/vsprint/vsmember/Table.html:61
		components.StreamPagination(qw422016, len(models)+prms.Offset, prms, ps.URI)
//line views/vsprint/vsmember/Table.html:61
		qw422016.N().S(`
  <div class="clear"></div>
`)
//line views/vsprint/vsmember/Table.html:63
	}
//line views/vsprint/vsmember/Table.html:64
}
