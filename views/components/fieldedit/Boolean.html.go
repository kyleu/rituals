...
//line views/components/fieldedit/Boolean.html:4
	if isBool && b {
//line views/components/fieldedit/Boolean.html:4
		qw422016.N().S(`<label class="radio-label"><input value="true" name="`)
...
//line views/components/fieldedit/Boolean.html:10
	if isBool && !b {
//line views/components/fieldedit/Boolean.html:10
		qw422016.N().S(`<label class="radio-label"><input value="false" name="`)
...
//line views/components/fieldedit/Boolean.html:17
		if x == nil {
//line views/components/fieldedit/Boolean.html:17
			qw422016.N().S(`<label class="radio-label"><input value="∅" name="`)
