...
func (s *Service) GetMultiple(ctx context.Context, tx *sqlx.Tx, logger util.Logger, ids ...uuid.UUID) (Stories, error) {
	if len(ids) == 0 {
		return Stories{}, nil
	}
...
func (s *Service) ListSQL(ctx context.Context, tx *sqlx.Tx, sql string, logger util.Logger) (Stories, error) {
	ret := dtos{}
