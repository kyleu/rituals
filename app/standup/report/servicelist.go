...
func (s *Service) List(ctx context.Context, tx *sqlx.Tx, params *filter.Params, logger util.Logger) (Reports, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to get reports")
	}
...
func (s *Service) ListWhere(ctx context.Context, tx *sqlx.Tx, where string, params *filter.Params, logger util.Logger, values ...any) (Reports, error) {
	params = filters(params)
...
func (s *Service) Count(ctx context.Context, tx *sqlx.Tx, whereClause string, logger util.Logger, args ...any) (int, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "unable to get count of reports")
	}
	return int(ret), nil
}
