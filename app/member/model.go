...
var RoleOwner = Role{Key: npncore.KeyOwner, Title: "Owner", Description: "can do pretty much anything"}
var RoleMember = Role{Key: npncore.KeyMember, Title: "Member", Description: "can participate in the session"}
