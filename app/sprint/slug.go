...
func (s *Service) Slugify(ctx context.Context, id uuid.UUID, n string, o string, h *shistory.Service, tx *sqlx.Tx, logger util.Logger) string {
	n = util.Slugify(n)
	if n == o {
		return n
	}
...
func (s *Sprint) PublicWebPath() string {
	return "/sprint/" + s.Slug
}

func (s *Sprint) IconSafe() string {
