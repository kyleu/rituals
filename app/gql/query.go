...
func queryFields() graphql.Fields {
	return graphql.Fields{
		npncore.KeyProfile: &graphql.Field{Type: graphql.NewNonNull(profileType), Resolve: ctxF(profileResolver)},
		...
		npncore.Plural(util.KeyStory): &graphql.Field{Type: graphql.NewNonNull(graphql.NewList(graphql.NewNonNull(storyType))), Description: "Get available stories", Args: listArgs, Resolve: ctxF(storiesResolver)},
		...
		npncore.KeyUser:                 &graphql.Field{Type: profileType, Description: "Get user", Args: idArgs, Resolve: ctxF(userResolver)},
		npncore.Plural(npncore.KeyUser): &graphql.Field{Type: graphql.NewNonNull(graphql.NewList(graphql.NewNonNull(profileType))), Description: "Get available users", Args: listArgs, Resolve: ctxF(usersResolver)},

		npncore.KeyAction:                 &graphql.Field{Type: actionType, Description: "Get action by id", Args: idArgs, Resolve: ctxF(actionResolver)},
		npncore.Plural(npncore.KeyAction): &graphql.Field{Type: graphql.NewNonNull(graphql.NewList(graphql.NewNonNull(actionType))), Description: "Get action list", Args: listArgs, Resolve: ctxF(actionsResolver)},

		npncore.KeySandbox:                 &graphql.Field{Type: sandboxType, Description: "Get sandbox by key", Args: keyArgs, Resolve: ctxF(sandboxResolver)},
		npncore.Plural(npncore.KeySandbox): &graphql.Field{Type: graphql.NewNonNull(graphql.NewList(graphql.NewNonNull(sandboxType))), Description: "Get sandbox list", Args: listArgs, Resolve: ctxF(sandboxesResolver)},
	}
}
