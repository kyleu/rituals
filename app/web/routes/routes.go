...
func BuildRouter(app *config.AppInfo) (*mux.Router, error) {
	...
	r.Path(p(util.SvcTeam.Key, "{key}", util.KeyExport, "{fmt}")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.TeamExport))).Name(n(util.SvcTeam.Key, util.KeyExport))
	...
	r.Path(p(util.SvcSprint.Key, "{key}", util.KeyExport, "{fmt}")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.SprintExport))).Name(n(util.SvcSprint.Key, util.KeyExport))
	...
	r.Path(p(util.SvcEstimate.Key, "{key}", util.KeyExport, "{fmt}")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.EstimateExport))).Name(n(util.SvcEstimate.Key, util.KeyExport))
	...
	r.Path(p(util.SvcStandup.Key, "{key}", util.KeyExport, "{fmt}")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.StandupExport))).Name(n(util.SvcStandup.Key, util.KeyExport))
	...
	r.Path(p(util.SvcRetro.Key, "{key}", util.KeyExport, "{fmt}")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.RetroExport))).Name(n(util.SvcRetro.Key, util.KeyExport))
	...
	r.Path(p("qr")).Methods(http.MethodGet).Handler(addContext(r, app, http.HandlerFunc(controllers.QRCode))).Name(n("qr"))
