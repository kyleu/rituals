...
func (s *Service) UpdateVote(storyID uuid.UUID, userID uuid.UUID, choice string) (*Vote, error) {
	...
	if curr == nil {
		...
		s.Data.Actions.Post(util.SvcEstimate, *estimateID, userID, action.ActVoteAdd, actionContent, "")
	...
	s.Data.Actions.Post(util.SvcEstimate, *estimateID, userID, action.ActVoteUpdate, actionContent, "")
