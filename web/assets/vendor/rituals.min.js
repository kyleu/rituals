...
f),h=new EmojiButton(d);h.on("emoji",function(l){drop.onEmojiPicked();dom.insertAtCaret(k,l)});h.togglePicker(g)},!1)})}}b.setTheme=e;b.linkColor="";b.themeLinks=function(a){b.linkColor=a+"-fg";dom.els(".theme").forEach(function(d){d.classList.add(b.linkColor)})}})(style||(style={}));var estimate;
...
m=permission.readPermissions();socket.send({svc:services.estimate.key,cmd:command.client.updateSession,param:{title:g,choices:k,teamID:h,sprintID:l,permissions:m}})};b.onStoryUpdate=c;b.onStoryRemove=a})(estimate||(estimate={}));var drop;
...
dom.req("#model-title").innerText);setTimeout(function(){return c.focus()},250);team.refreshTeams();sprint.refreshSprints()}})(session||(session={}));var socket;
(function(b){function e(){var n=document.location,p="ws";"https:"===n.protocol&&(p="wss");return p+("://"+n.host+"/s")}function c(n,p){system.cache.currentService=n;system.cache.currentID=p;system.cache.connectTime=Date.now();k=new WebSocket(e());k.onopen=function(){return d};k.onmessage=function(q){q=JSON.parse(q.data);f(q)};k.onerror=function(q){};k.onclose=g}function a(n){h?(debug&&console.debug("out",n),n=JSON.stringify(n,null,2),k.send(n)):m.push(n)}function d(n,p){h=!0;m.forEach(a);m=[];a({svc:system.cache.currentService.key,
cmd:command.client.connect,param:system.cache.currentID})}function f(n){debug&&console.debug("in",n);switch(n.svc){case services.system.key:system.onSystemMessage(n.cmd,n.param);break;case services.team.key:team.onTeamMessage(n.cmd,n.param);break;case services.sprint.key:sprint.onSprintMessage(n.cmd,n.param);break;case services.estimate.key:estimate.onEstimateMessage(n.cmd,n.param);break;case services.standup.key:standup.onStandupMessage(n.cmd,n.param);break;case services.retro.key:retro.onRetroMessage(n.cmd,
n.param);break;default:console.warn("unhandled message for service ["+n.svc+"]")}}function g(){function n(p){debug&&console.info("socket closed, reconnecting in "+p+" seconds");setTimeout(function(){c(system.cache.currentService,system.cache.currentID)},1E3*p)}l||n(10)}var k,h=!1,l=!1,m=[];b.setAppUnloading=function(){l=!0};b.socketConnect=c;b.send=a;b.onSocketMessage=f})(socket||(socket={}));var sprint;
