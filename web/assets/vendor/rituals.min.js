...
$jscomp.arrayFromIterator=function(b){for(var e,c=[];!(e=b.next()).done;)c.push(e.value);return c};$jscomp.arrayFromIterable=function(b){return b instanceof Array?b:$jscomp.arrayFromIterator($jscomp.makeIterator(b))};$jscomp.findInternal=function(b,e,c){b instanceof String&&(b=String(b));for(var a=b.length,d=0;d<a;d++){var f=b[d];if(e.call(c,f,d,b))return{i:d,v:f}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,e,c){if(b==Array.prototype||b==Object.prototype)return b;b[e]=c.value;return b};
...
$jscomp.propertyToPolyfillSymbol[d],$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:e})))};$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(e,c){return $jscomp.findInternal(this,e,c).v}},"es6","es3");
...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(e,c){var a=$jscomp.checkStringArgs(this,e,"startsWith");e+="";var d=a.length,f=e.length;c=Math.max(0,Math.min(c|0,a.length));for(var g=0;g<f&&c<d;)if(a[c++]!=e[g++])return!1;return g>=f}},"es6","es3");
$jscomp.polyfill("String.prototype.endsWith",function(b){return b?b:function(e,c){var a=$jscomp.checkStringArgs(this,e,"endsWith");e+="";void 0===c&&(c=a.length);c=Math.max(0,Math.min(c|0,a.length));for(var d=e.length;0<d&&0<c;)if(a[--c]!=e[--d])return!1;return 0>=d}},"es6","es3");var dom;
(function(b){function e(g,h){var k=[];(h?h.querySelectorAll(g):document.querySelectorAll(g)).forEach(function(l){k.push(l)});return k}function c(g,h){h=e(g,h);switch(h.length){case 0:break;case 1:return h[0];default:console.warn("found ["+h.length+"] elements with selector ["+g+"], wanted zero or one")}}function a(g,h){(h=c(g,h))||console.warn("no element found for selector ["+g+"]");return h}function d(g,h){"string"===typeof g&&(g=a(g));g.innerHTML=h;return g}function f(g,h,k){k=void 0===k?"block":
k;"string"===typeof g&&(g=a(g));g.style.display=h?k:"none";return g}b.initDom=function(g,h){try{style.themeLinks(h),style.setTheme(g)}catch(k){console.warn("error setting style",k)}try{modal.wire()}catch(k){console.warn("error wiring modals",k)}try{drop.wire()}catch(k){console.warn("error wiring drops",k)}try{tags.wire()}catch(k){console.warn("error wiring tag editors",k)}try{flash.wire()}catch(k){console.warn("error wiring tag editors",k)}};b.els=e;b.opt=c;b.req=a;b.setHTML=d;b.setDisplay=f;b.setContent=
function(g,h){"string"===typeof g&&(g=a(g));b.clear(g);Array.isArray(h)?h.forEach(function(k){return g.appendChild(k)}):g.appendChild(h);return g};b.setText=function(g,h){"string"===typeof g&&(g=a(g));g.innerText=h;return g};b.switchElements=function(g,h){f(g,!1);f(h,!0);return!1};b.clear=function(g){return d(g,"")}})(dom||(dom={}));
...
function JSX(b,e){var c=document.createElement(b);for(d in e)if(d&&e.hasOwnProperty(d)){var a=e[d];"dangerouslySetInnerHTML"===d?dom.setHTML(c,a.__html):!0===a?c.setAttribute(d,d):!1!==a&&null!==a&&void 0!==a&&c.setAttribute(d,a.toString())}var d={};for(a=2;a<arguments.length;d={$jscomp$loop$prop$child$7:d.$jscomp$loop$prop$child$7},a++)if(d.$jscomp$loop$prop$child$7=arguments[a],Array.isArray(d.$jscomp$loop$prop$child$7))d.$jscomp$loop$prop$child$7.forEach(function(f){return function(g){if(void 0===f.$jscomp$loop$prop$child$7||
null===f.$jscomp$loop$prop$child$7)throw"child array for tag ["+b+"] is "+f.$jscomp$loop$prop$child$7+"\n"+c.outerHTML;if(void 0===g||null===g)throw"child for tag ["+b+"] is "+g+"\n"+c.outerHTML;"string"===typeof g&&(g=document.createTextNode(g));c.appendChild(g)}}(d));else{if(void 0===d.$jscomp$loop$prop$child$7||null===d.$jscomp$loop$prop$child$7)throw"child for tag ["+b+"] is "+d.$jscomp$loop$prop$child$7+"\n"+c.outerHTML;d.$jscomp$loop$prop$child$7.nodeType||(d.$jscomp$loop$prop$child$7=document.createTextNode(d.$jscomp$loop$prop$child$7.toString()));
c.appendChild(d.$jscomp$loop$prop$child$7)}return c}var style;
(function(b){function e(a){c(a);switch(a){case "auto":a="light";window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(a="dark");e(a);fetch("/profile/theme/"+a).then(function(d){return d.text()}).then(function(){});break;case "light":document.documentElement.classList.remove("uk-light");document.body.classList.remove("uk-light");document.documentElement.classList.add("uk-dark");document.body.classList.add("uk-dark");break;case "dark":document.documentElement.classList.add("uk-light");
document.body.classList.add("uk-light");document.documentElement.classList.remove("uk-dark");document.body.classList.remove("uk-dark");break;default:console.warn("invalid theme")}}function c(a){if("undefined"===typeof EmojiButton)dom.els(".picker-toggle").forEach(function(f){return dom.setDisplay(f,!1)});else{var d={position:"bottom-end",theme:a,zIndex:1021};dom.els(".textarea-emoji").forEach(function(f){var g=dom.req(".picker-toggle",f);g.addEventListener("click",function(){var h=dom.req(".uk-textarea",
f),k=new EmojiButton(d);k.on("emoji",function(l){drop.onEmojiPicked();dom.insertAtCaret(h,l)});k.togglePicker(g)},!1)})}}b.setTheme=e;b.linkColor="";b.themeLinks=function(a){b.linkColor=a+"-fg";dom.els(".theme").forEach(function(d){d.classList.add(b.linkColor)})}})(style||(style={}));var drop;
(function(b){function e(f){if(f.target){var g=f.target;f=g.dataset.key||"";g=g.dataset.t||"";var h=events.getOpenEvent(f);h?h(g):console.warn("no drop open handler registered for ["+f+"]")}}function c(f){if(f.target){var g=f.target;g.classList.contains("uk-open")&&(f=g.dataset.t||"",(g=events.getCloseEvent(g.dataset.key||""))&&g(f))}}function a(f){d&&f.preventDefault()}b.wire=function(){dom.els(".drop").forEach(function(f){f.addEventListener("show",e);f.addEventListener("beforehide",a);f.addEventListener("hide",
c)})};var d=!1;b.onEmojiPicked=function(){d=!0;setTimeout(function(){return d=!1},200)}})(drop||(drop={}));var events;(function(b){var e,c;b.register=function(a,d,f){e||(e=new map.Map);c||(c=new map.Map);d||(d=function(){});e.set(a,d);f&&c.set(a,f)};b.getOpenEvent=function(a){return e.get(a)};b.getCloseEvent=function(a){return c.get(a)}})(events||(events={}));var flash;
(function(b){function e(){var a=!1;dom.els(".alert-top").forEach(function(d){a=!0;d.classList.add("uk-animation-fade","uk-animation-reverse")});a&&setTimeout(c,1E3)}function c(){dom.els(".alert-top").forEach(function(a){a.remove()})}b.wire=function(){setTimeout(e,4E3)}})(flash||(flash={}));var modal;
...
a)})};b.open=e;b.openSoon=function(f){setTimeout(function(){return e(f)},0)};b.hide=function(f){f=notify.modal("#modal-"+f);f.$el.classList.contains("uk-open")&&f.hide()}})(modal||(modal={}));var tags;
(function(b){function e(d){var f=dom.req(".value",d),g=dom.req(".editor",d);dom.setDisplay(f,!1);dom.setDisplay(g,!0);var h=b.renderInput(f.innerText);h.onblur=function(){f.innerText=h.value;dom.setDisplay(f,!0);dom.setDisplay(g,!1);a(d.parentElement)};h.onkeypress=function(k){return"Enter"===k.key?(h.blur(),!1):!0};dom.setContent(g,h);h.focus()}function c(d){d.target?a(d.target):console.warn("no event target")}function a(d){var f=d.dataset.key||"",g=events.getOpenEvent(f);g?g():console.warn("no tag open handler registered for ["+
f+"]");d=dom.els(".item",d).map(function(h){return h.innerText});dom.setValue("#model-"+f+"-input",d.join(","))}b.wire=function(){dom.els(".tag-editor").forEach(function(d){d.addEventListener("moved",c);d.addEventListener("added",c);d.addEventListener("removed",c)})};b.removeTag=function(d){d=d.parentElement;var f=d.parentElement;d.remove();a(f)};b.addTag=function(d){if(d=d.parentElement){var f=b.renderItem();d.insertBefore(f,dom.req(".add-item",d));e(f)}};b.editTag=e})(tags||(tags={}));
...
(function(b){function e(){var n=document.location,p="ws";"https:"===n.protocol&&(p="wss");return p+("://"+n.host+"/s")}function c(){g=new WebSocket(e());g.onopen=d;g.onmessage=function(n){return l(json.parse(n.data))};g.onerror=function(n){return m("socket",n.type)};g.onclose=f}function a(n,p,q){b.currentService=n;b.currentID=p;b.connectTime=Date.now();if(!l)throw"onMessage not initialized";q?b.initBypass():c()}function d(){log.info("socket connected");b.connected=!0;h=1;k.forEach(b.send);k=[]}function f(){function n(){b.connected=
!1;var p=Date.now()-b.connectTime;2E3>p?(h*=2,b.debug&&console.debug("socket closed immediately, reconnecting in "+h+" seconds"),setTimeout(function(){a(b.currentService,b.currentID)},1E3*h)):(log.info("socket closed after ["+p+"ms]"),a(b.currentService,b.currentID))}b.appUnloading||n()}var g;b.connected=!1;var h=0,k=[],l,m;b.init=function(n,p){l=n;m=p};b.initSocket=c;b.socketConnect=a;b.socketSend=function(n){b.debug&&console.debug("out",n);b.connected?(n=json.str(n),g.send(n)):k.push(n)}})(socket||
(socket={}));var profile;
...
b.setPicture=function(e){dom.setValue("#self-picture-input",e);return!1}})(profile||(profile={}));var arr;(function(b){b.find=function(e,c){for(var a=e.length>>>0,d=0;d<a;){var f=e[d];if(c(d,f))return f;d++}}})(arr||(arr={}));var date;
...
b.toDateString=e;b.toTimeString=c;b.toDateTimeString=function(d){return e(d)+" "+c(d)};var a=6E4*(new Date).getTimezoneOffset();b.utcDate=function(d){return new Date(Date.parse(d)+a)}})(date||(date={}));var group;
(function(b){function e(f,g){if(!f)return[];f.sort(function(h,k){h=g(h);k=g(k);return h>k?1:h<k?-1:0});return f}function c(f,g,h){if(!f)return[g];var k=!1,l=h(g),m;for(m in f)h(f[m])==l&&(k=!0,f[m]=g);k||f.push(g);return f}var a=function(f){this.members=[];this.key=f};b.Group=a;var d=function(){this.groups=[]};d.prototype.findOrInsert=function(f){var g=arr.find(this.groups,function(h,k){return k.key===f});if(g)return g;g=new a(f);this.groups.push(g);return g};b.GroupSet=d;b.groupBy=function(f,g){var h=
new d;f&&f.forEach(function(k){h.findOrInsert(g(k)).members.push(k)});return h};b.findGroup=function(f,g){f=$jscomp.makeIterator(f);for(var h=f.next();!h.done;h=f.next())if(h=h.value,h.key===g)return h.members;return[]};b.flatten=function(f){var g=[];f.forEach(function(h){return g.push.apply(g,$jscomp.arrayFromIterable(h))});return g};b.sort=e;b.update=c;b.updateAndSort=function(f,g,h){return e(c(f,g,h),h)}})(group||(group={}));var json;
...
(function(b){function e(g,h){if(0===a)console.warn("call `log.init()` before attempting to log");else{var k=Date.now()-a;k=JSX("li",{class:c(g)},JSX("div",{class:"right"},k,"ms"),h);if(!f&&(f=dom.opt("#log-list"),!f)){console.warn(g+": "+h);return}f.appendChild(k);d||(d=dom.req("#log-content"));d.scrollTo(0,d.scrollHeight)}}function c(g){switch(g){case "debug":return"grey-fg";case "info":return"";case "warn":return"yellow-fg";case "error":return"red-fg";default:return""}}var a=0,d,f;b.init=function(){a=
Date.now();e("debug","npn started")};b.info=function(g){e("info",g)};b.l=e;b.toggle=function(){var g=dom.req("#workspace-content"),h=dom.req("#log-container"),k=""!==h.style.display&&"none"!==h.style.display;k?g.classList.remove("log-visible"):g.classList.add("log-visible");dom.setDisplay(h,!k);d||(d=dom.req("#log-content"));d.scrollTo(0,d.scrollHeight)}})(log||(log={}));var map;
(function(b){var e=function(){this.storage=Object.create(null)};e.prototype.get=function(c){return this.storage[c]};e.prototype.set=function(c,a){return this.storage[c]=a};b.Map=e})(map||(map={}));var nav;
(function(b){function e(a){if(!b.enabled)return c(a),"";if(str.startsWith(a,"text/html;"))return"";str.startsWith(a,"/")&&(a=a.substr(1));var d=location.pathname;str.startsWith(d,"/")&&(d=d.substr(1));d!==a&&(d=a,history.pushState(d,"","/"+d));c(a)}b.enabled=!0;var c=function(a){console.warn("default nav handler called: "+a)};b.init=function(a){c=a;window.onpopstate=function(d){d.state?c(d.state):c("")};e(location.pathname)};b.pop=function(){var a=location.pathname.substr(0,location.pathname.lastIndexOf("/"));
"/c"===a&&(a="");e(a)};b.navigate=e;b.link=function(a){var d=a.path;str.startsWith(d,"/")||(d="/"+d);a.cls=a.cls?" "+a.cls.trim():"";var f=JSX("span",null);a.icon&&(f=JSX("span",{class:"nav-icon","data-uk-icon":"icon: "+a.icon}));a.onclk?str.endsWith(a.onclk,";")||(a.onclk+=";"):a.onclk="";a.isButton||(a.cls=style.linkColor+a.cls);return JSX("a",{class:a.cls,href:d,onclick:a.onclk+"nav.navigate('"+a.path+"', '"+a.title+"');return false;"},f,a.title)}})(nav||(nav={}));var notify;
(function(b){b.notify=function(e,c){UIkit.notification(e,{status:c?"success":"danger",pos:"top-right"})};b.confirm=function(e,c){UIkit.modal.confirm(e).then(c)};b.modal=function(e){var c=UIkit.modal(e);c||console.warn("no modal available with key ["+e+"]");return c}})(notify||(notify={}));var str;
(function(b){function e(a,d,f){f=f&&0<f?f|0:0;return a.substring(f,f+d.length)===d}function c(a,d,f){f=f&&f<a.length?f:a.length;return a.substring(f-d.length,f)===d}b.startsWith=e;b.endsWith=c;b.trimPrefix=function(a,d){return e(a,d)?a.slice(d.length):a};b.trimSuffix=function(a,d){return c(a,d)?a.substring(0,a.lastIndexOf(d)):a}})(str||(str={}));var rituals;
(function(b){function e(a,d){console.error(a+": "+d);var f=d.lastIndexOf(":");-1<f&&(d=d.substr(f+1));notify.notify(a+" error: "+d,!1)}function c(a){debug&&console.debug("in",a);switch(a.svc){case services.system.key:system.onSystemMessage(a.cmd,a.param);break;case services.team.key:team.onTeamMessage(a.cmd,a.param);break;case services.sprint.key:sprint.onSprintMessage(a.cmd,a.param);break;case services.estimate.key:estimate.onEstimateMessage(a.cmd,a.param);break;case services.standup.key:standup.onStandupMessage(a.cmd,
a.param);break;case services.retro.key:retro.onRetroMessage(a.cmd,a.param);break;default:console.warn("unhandled message for service ["+a.svc+"]")}}b.onError=e;b.init=function(a,d){window.onbeforeunload=function(){socket.setAppUnloading()};socket.init(c,e);socket.socketConnect(a,d)}})(rituals||(rituals={}));var action;
...
(function(b){function e(k,l){k&&"modal"!==k||(k=g,l||(l=h));"root"===k&&(k="");return l?f.filter(function(m){return m.targetType===k&&m.targetID==l}):f.filter(function(m){return m.targetType===k})}function c(k,l){k&&"modal"!==k||(k=g,l||(l=h));if(k){if(g=k,h=l,l=e(k,l),"root"!==k&&(k="modal"),dom.setContent("#drop-comment-"+k+" .uk-card-body",b.renderComments(l,system.cache.getProfile())),k=dom.opt("#drop-comment-"+k+" .uk-comment-list"))k.scrollTop=k.scrollHeight}else console.warn("invalid comment type ["+
k+"]")}function a(){var k=dom.els(".comment-count-container"),l=!1,m=dom.opt("#comment-count-modal");k.forEach(function(n){var p=n.dataset.commentType,q=n.dataset.commentId;if(!p)throw"invalid comment type ["+p+"] with id ["+q+"]";q=e(p,q);d(p,q,n);g===p&&m&&(d(p,q,m),l=!0)});!l&&m&&d("modal",[],m,!0)}function d(k,l,m,n){dom.setText(dom.req(".text",m),l.length.toString());"root"!==k&&"modal"!==k&&0!==k.length&&dom.setDisplay(m,0!==l.length||!0===n)}var f=[],g,h;b.applyComments=function(k){f=k};b.setActive=
function(k,l){g=k;h=l};b.show=function(k){modal.open("comment",k)};b.add=function(k){k=dom.req("#comment-add-content-"+k);var l=k.value.trim();0===l.length?notify.notify("enter some content",!0):(k.value="",socket.send({svc:services.system.key,cmd:command.client.addComment,param:{targetType:g,targetID:h,content:l}}))};b.onCommentUpdate=function(k){f.push(k);a();c()};b.load=c;b.setCounts=a;b.closeDrop=function(){"story"===g?modal.openSoon("story"):"report"===g?modal.openSoon("report"):"feedback"===
g&&modal.openSoon("feedback");g=void 0};b.remove=function(k){confirm("remove this comment?")&&socket.send({svc:services.system.key,cmd:command.client.removeComment,param:k});return!1};b.onCommentRemoved=function(k){f=f.filter(function(l){return l.id!==k});a();c()}})(comment||(comment={}));
...
(function(b){function e(g){b.cache.detail=g;var h=g.choices.join(", ");dom.setValue("#model-choices-input",h);dom.setContent("#session-view-section .choices",tags.renderTagsView(g.choices));story.viewActiveStory();session.setDetail(g)}function c(g){var h=d(g.id);h.push(g);h.sort(function(k){return k.idx});g.id===b.cache.activeStory&&dom.setText("#story-title",g.title);story.setStories(h)}function a(g){var h=d(g);story.setStories(h);g===b.cache.activeStory&&modal.hide("story");notify.notify("story has been deleted",
!0)}function d(g){return b.cache.stories.filter(function(h){return h.id!==g})}var f=function(){this.stories=[];this.votes=[]};f.prototype.activeVotes=function(){var g=this;return this.activeStory?this.votes.filter(function(h){return h.storyID===g.activeStory}):[]};b.cache=new f;b.onEstimateMessage=function(g,h){switch(g){case command.server.error:rituals.onError(services.estimate.key,h);break;case command.server.sessionJoined:session.onSessionJoin(h);e(h.session);story.setStories(h.stories);vote.setVotes(h.votes);
session.showWelcomeMessage(h.session.status,h.members.length);break;case command.server.sessionUpdate:e(h);break;case command.server.sessionRemove:system.onSessionRemove(services.estimate);break;case command.server.permissionsUpdate:system.setPermissions(h);break;case command.server.teamUpdate:b.cache.detail&&(b.cache.detail.teamID=null===h||void 0===h?void 0:h.id);session.setTeam(h);break;case command.server.sprintUpdate:b.cache.detail&&(b.cache.detail.sprintID=null===h||void 0===h?void 0:h.id);
session.setSprint(h);break;case command.server.storyUpdate:c(h);break;case command.server.storyRemove:a(h);break;case command.server.storyStatusChange:story.onStoryStatusChange(h);break;case command.server.voteUpdate:vote.onVoteUpdate(h);break;default:console.warn("unhandled command ["+g+"] for estimate")}};b.onSubmitEstimateSession=function(){var g=dom.req("#model-title-input").value,h=dom.req("#model-choices-input").value,k=dom.req("#model-team-select select").value,l=dom.req("#model-sprint-select select").value,
m=permission.readPermissions();socket.send({svc:services.estimate.key,cmd:command.client.updateSession,param:{title:g,choices:h,teamID:k,sprintID:l,permissions:m}})};b.onStoryUpdate=c;b.onStoryRemove=a})(estimate||(estimate={}));var feedback;
...
b.renderFeedbackArray(d));comment.setCounts();modal.hide("add-feedback")};b.onSubmitFeedback=function(){var d=dom.req("#feedback-category").value,f=dom.req("#feedback-content").value;socket.send({svc:services.retro.key,cmd:command.client.addFeedback,param:{category:d,content:f}});return!1};b.onEditFeedback=function(){var d=retro.cache.activeFeedback,f=dom.req("#feedback-edit-category").value,g=dom.req("#feedback-edit-content").value;socket.send({svc:services.retro.key,cmd:command.client.updateFeedback,
param:{id:d,category:f,content:g}});return!1};b.onRemoveFeedback=function(){var d=retro.cache.activeFeedback;d&&notify.confirm("Delete this feedback?",function(){socket.send({svc:services.retro.key,cmd:command.client.removeFeedback,param:d});modal.hide("feedback")});return!1};b.getActiveFeedback=e;b.viewActiveFeedback=function(d){var f,g=system.cache.getProfile();d&&(retro.cache.activeFeedback=d);(d=e())?(g=d.userID===g.userID,dom.setText("#feedback-title",d.category+" / "+(null===(f=member.getMember(d.userID))||
void 0===f?void 0:f.name)),dom.setSelectOption("#feedback-edit-category",g?d.category:void 0),contents.onContentDisplay("feedback",g,d.content,d.html),comment.setActive("feedback",d.id),comment.setCounts()):console.warn("no active feedback")};b.onFeedbackUpdate=function(d){var f=c(d.id);f.push(d);a(f,d.id)};b.onFeedbackRemoved=function(d){var f=c(d);a(f,d);notify.notify("feedback has been deleted",!0)};b.getFeedbackCategories=function(d,f){var g=f.map(function(k){var l=d.filter(function(m){return m.category===
k}).sort(function(m,n){return m.created>n.created?-1:1});return{category:k,feedback:l}}),h=d.filter(function(k){return!f.find(function(l){return l===k.category})});0<h.length&&g.push({category:"unknown",feedback:h});return g};b.viewAddFeedback=function(d){dom.setSelectOption("#feedback-category",d);var f=dom.setValue("#feedback-content","");dom.wireTextarea(f);setTimeout(function(){return f.focus()},250)};b.viewFeedback=function(d){feedback.viewActiveFeedback(d);var f=dom.req("#feedback-edit-content");
...
(function(b){function e(){var f=a.filter(b.isSelf).shift();b.updateSelf(f);f=a.filter(function(g){return!b.isSelf(g)});dom.setContent("#member-detail",b.renderMembers(f));0<f.length&&modal.hide("welcome");b.renderOnline()}function c(){if(d){var f=a.filter(function(g){return g.userID===d}).shift();f||console.warn("cannot load active member ["+d+"]");return f}console.warn("no active member")}var a=[],d;b.getMember=function(f){return a.filter(function(g){return g.userID===f}).shift()};b.getMembers=function(){return a};
b.setMembers=e;b.onMemberUpdate=function(f){b.isSelf(f)?modal.hide("self"):modal.hide("member");var g=a,h=g.filter(function(k){return k.userID===f.userID}).shift();h=(null===h||void 0===h?void 0:h.name)!==f.name;g=g.filter(function(k){return k.userID!==f.userID});g.length===a.length&&notify.notify(f.name+" has joined",!0);g.push(f);g.sort(function(k,l){return k.name>l.name?1:-1});a=g;e();b.memberUpdateDom(h)};b.onMemberRemove=function(f){var g;f===system.cache.getProfile().userID?(notify.notify("you have left this "+
(null===(g=system.cache.currentService)||void 0===g?void 0:g.key),!0),document.location.href="/"):(modal.hide("member"),g=a.filter(function(h){return h.userID!==f}),g.sort(function(h,k){return h.name>k.name?1:-1}),a=g,e())};b.viewActiveMember=function(f){f&&(d=f);(f=c())&&b.activeMemberDom(f)};b.removeMember=function(f){(f=void 0===f?d:f)||console.warn("cannot load active member ["+d+"]");"self"===f&&(f=system.cache.getProfile().userID);var g=system.cache.currentService;confirm("Are you sure you wish to leave this "+
g.key+"?")&&socket.send({svc:g.key,cmd:command.client.removeMember,param:f})};b.saveRole=function(){var f=c();if(f){var g=f.role,h=dom.req("#member-modal-role-select").value;g===h?modal.hide("member"):socket.send({svc:system.cache.currentService.key,cmd:command.client.updateMember,param:{id:f.userID,role:h}})}else console.warn("no active member")};b.applyMembers=function(f){a=f};b.loadQR=function(){var f=dom.req("#qrcode");f.src=f.dataset.src}})(member||(member={}));
...
(function(b){var e;b.isSelf=function(c){var a=system.cache.getProfile().userID;return c.userID===a};b.selfCanEdit=function(){return void 0!==e&&"owner"==e.role};b.updateSelf=function(c){var a=!1;c&&(e=c,dom.setContent("#self-picture",b.setPicture(c.picture)),dom.setText("#member-self .member-name",c.name),dom.setValue("#self-name-input",c.name),dom.setText("#member-self .member-role",c.role),a="owner"==c.role);dom.setDisplay("#history-container",a);dom.setDisplay("#session-edit-section",a);dom.setDisplay("#session-view-section",
!a)};b.onSubmitSelf=function(){var c=dom.req("#self-name-input").value,a=dom.req("#self-name-choice-global").checked?"global":"local",d=dom.req("#self-picture-input").value;socket.send({svc:services.system.key,cmd:command.client.updateProfile,param:{name:c,choice:a,picture:d}})}})(member||(member={}));var command;
(function(b){b.client={ping:"ping",connect:"connect",setActive:"set-active",getActions:"get-actions",getTeams:"get-teams",getSprints:"get-sprints",updateSession:"update-session",addComment:"add-comment",updateComment:"update-comment",removeComment:"remove-comment",updateProfile:"update-profile",updateMember:"update-member",removeMember:"remove-member",addStory:"add-story",updateStory:"update-story",removeStory:"remove-story",setStoryStatus:"set-story-status",submitVote:"submit-vote",addReport:"add-report",
...
(function(b){function e(c){switch(c.key){case services.team.key:return JSX("li",null,"Must be a member of this session's team");case services.sprint.key:return JSX("li",null,"Must be a member of this session's sprint");default:var a=group.flatten(c.members.map(function(d){return d.k.split(",").map(function(f){return f.trim()}).filter(function(f){return 0<f.length})}));return 0===a.length?JSX("li",null,"Must sign in with ",c.key):JSX("li",null,"Must sign in with ",c.key," using an email address from ",
...
(function(b){function e(c,a){dom.els(".perm-"+c+"-email").forEach(function(d){d.disabled=!a;a||(d.checked=!1)})}b.setProviderPerms=function(c){var a=group.findGroup(b.permissions,c.key),d=auth.active().filter(function(h){return h.provider===c.key});if(dom.opt("#perm-"+c.key+"-section")){dom.req("#perm-"+c.key+"-checkbox").checked=0<a.length;var f=dom.req("#perm-"+c.key+"-email-container"),g=group.flatten(a.map(function(h){return h.v.split(",").filter(function(k){return 0<k.length})})).map(function(h){return{matched:!0,
domain:h}});a=d.filter(function(h){return 0===g.filter(function(k){return h.email.endsWith(k.domain)}).length}).map(function(h){h=h.email;var k=h.lastIndexOf("@");h=-1===k?h:h.substr(k);return{matched:!1,domain:h}});g.push.apply(g,$jscomp.arrayFromIterable(a));g.sort();dom.setDisplay(f,0<g.length);dom.setContent(f,0===g.length?document.createElement("span"):b.renderEmails(c.key,g))}};b.onChanged=function(c,a,d){switch(c){case "email":(c=dom.opt("#perm-"+a+"-checkbox"))&&d&&!c.checked&&(c.checked=
...
b.onSessionJoin=function(e){system.cache.apply(e);permission.setPerms();member.setMembers();comment.setCounts()};b.showWelcomeMessage=function(e,c){"new"===e&&1===c&&(socket.send({svc:services.system.key,cmd:command.client.setActive,param:null}),setTimeout(function(){return modal.open("welcome")},300))};b.setTeam=function(e){var c=dom.req("#team-link-container"),a=dom.req("#session-view-section .team");dom.clear(c);dom.setDisplay("#team-warning-container",void 0!==e);e?(c.appendChild(team.renderTeamLink(e)),
dom.setContent(a,team.renderTeamLink(e,!0)),dom.setText("#team-warning-name",e.title)):dom.setHTML(a,"-none-")};b.setSprint=function(e){var c=dom.req("#sprint-link-container"),a=dom.req("#session-view-section .sprint");dom.clear(c);dom.setDisplay("#sprint-warning-container",void 0!==e);e?(c.appendChild(sprint.renderSprintLink(e)),dom.setContent(a,sprint.renderSprintLink(e,!0)),dom.setText("#sprint-warning-name",e.title)):dom.setHTML(a,"-none-")};b.onModalOpen=function(e){var c=dom.setValue("#model-title-input",
dom.req("#model-title").innerText);setTimeout(function(){return c.focus()},250);team.refreshTeams();sprint.refreshSprints()}})(session||(session={}));var sprint;
...
(function(b){b.renderSprintDates=function(e,c){function a(g,h){return JSX("span",null,g," ",JSX("span",{class:"sprint-date",onclick:"modal.open('session');"},h?date.toDateString(h):""))}var d=a("starts",e),f=a("ends",c);return e?c?JSX("span",null,d,", ",f):d:c?f:JSX("span",null,"Sprint")};b.renderSprintLink=function(e,c){var a=system.cache.getProfile();e=JSX("a",{class:a.linkColor+"-fg",href:"/sprint/"+e.slug},e.title);return c?e:JSX("span",null,e," ")};b.renderSprintSelect=function(e,c){return JSX("select",
...
(function(b){function e(a){return b.cache.reports.filter(function(d){return d.id!==a})}function c(a,d){report.setReports(a);d===b.cache.activeReport&&modal.hide("report")}b.cache=new function(){this.reports=[]};b.onStandupMessage=function(a,d){switch(a){case command.server.error:rituals.onError(services.standup.key,d);break;case command.server.sessionJoined:session.onSessionJoin(d);a=d.session;b.cache.detail=a;session.setDetail(a);report.setReports(d.reports);session.showWelcomeMessage(d.session.status,
d.members.length);break;case command.server.sessionUpdate:b.cache.detail=d;session.setDetail(d);break;case command.server.sessionRemove:system.onSessionRemove(services.standup);break;case command.server.permissionsUpdate:system.setPermissions(d);break;case command.server.teamUpdate:b.cache.detail&&(b.cache.detail.teamID=null===d||void 0===d?void 0:d.id);session.setTeam(d);break;case command.server.sprintUpdate:b.cache.detail&&(b.cache.detail.sprintID=null===d||void 0===d?void 0:d.id);session.setSprint(d);
break;case command.server.reportUpdate:a=e(d.id);a.push(d);c(a,d.id);break;case command.server.reportRemove:a=e(d);c(a,d);notify.notify("report has been deleted",!0);break;default:console.warn("unhandled command ["+a+"] for standup")}};b.onSubmitStandupSession=function(){var a=dom.req("#model-title-input").value,d=dom.req("#model-team-select select").value,f=dom.req("#model-sprint-select select").value,g=permission.readPermissions();socket.send({svc:services.standup.key,cmd:command.client.updateSession,
param:{title:a,teamID:d,sprintID:f,permissions:g}})}})(standup||(standup={}));var story;
(function(b){function e(a){function d(g,h){g.id.substr(g.id.lastIndexOf("-")+1)===h?g.classList.add("active"):g.classList.remove("active")}dom.els(".story-status-body").forEach(function(g){d(g,a)});dom.els(".story-status-actions").forEach(function(g){d(g,a)});var f="";switch(a){case "new":f="Story";break;case "active":f="Voting";break;case "complete":f="Results"}dom.setText("#story-status",f);vote.viewVotes()}function c(a,d,f,g){f&&"complete"===f.status&&0<f.finalVote.length&&(d=f.finalVote);dom.setContent("#story-"+
a+" .story-status",b.renderStatus(d));g&&b.showTotalIfNeeded()}b.viewStoryStatus=e;b.requestStoryStatus=function(a){var d=b.getActiveStory();d&&socket.send({svc:services.estimate.key,cmd:command.client.setStoryStatus,param:{storyID:d.id,status:a}})};b.setStoryStatus=c;b.onStoryStatusChange=function(a){var d=void 0;estimate.cache.stories.forEach(function(f){f.id===a.storyID&&(d=f,f.finalVote=a.finalVote,f.status=a.status)});c(a.storyID,a.status,d,!0);a.storyID===estimate.cache.activeStory&&e(a.status)}})(story||
(story={}));
...
b.beginEditStory=function(){var a=e(),d=prompt("Edit your story",a.title);d&&d!==a.title&&socket.send({svc:services.estimate.key,cmd:command.client.updateStory,param:{storyID:a.id,title:d}});return!1};b.onRemoveStory=function(){var a=estimate.cache.activeStory;a&&notify.confirm("Delete this story?",function(){socket.send({svc:services.estimate.key,cmd:command.client.removeStory,param:a});modal.hide("story")});return!1};b.getActiveStory=e;b.viewActiveStory=function(a){a&&(estimate.cache.activeStory=
...
c.status),JSX("div",{class:a.linkColor+"-fg section-link left"},c.title),JSX("div",{class:"left",style:"margin-top: 4px;"},comment.renderCount("story",c.id)))})))};b.renderStatus=function(e){switch(e){case "new":return JSX("span",null,e);case "active":return JSX("span",null,e);default:return JSX("span",{class:"vote-badge"},e)}};b.renderTotal=function(e){return JSX("li",{id:"story-total"},JSX("div",{class:"right uk-article-meta"},JSX("span",{class:"vote-badge"},e))," ","Total")};b.viewAddStory=function(){var e=
...
(function(b){function e(){var c=story.getActiveStory();if(c){var a=estimate.cache.activeVotes(),d=a.filter(function(f){return f.userID===system.cache.getProfile().userID}).pop();switch(c.status){case "new":c=system.cache.getProfile().userID===c.userID;dom.setDisplay("#story-edit-section",c);dom.setDisplay("#story-view-section",!c);break;case "active":dom.setContent("#story-vote-members",b.renderVoteMembers(member.getMembers(),a));dom.setContent("#story-vote-choices",b.renderVoteChoices(estimate.cache.detail.choices,
...
e()};b.viewVotes=e;b.onSubmitVote=function(c){socket.send({svc:services.estimate.key,cmd:command.client.submitVote,param:{storyID:estimate.cache.activeStory,choice:c}})};b.getVoteResults=function(c){c=c.map(function(k){k=parseFloat(k.choice);return isNaN(k)?-1:k}).filter(function(k){return-1!==k}).sort();var a=c.length,d=Math.min.apply(Math,$jscomp.arrayFromIterable(c)),f=Math.max.apply(Math,$jscomp.arrayFromIterable(c)),g=c.reduce(function(k,l){return k+l},0),h=c.reduce(function(k,l){var m=k.numMapping[l]=
(k.numMapping[l]||0)+1;m>k.greatestFreq&&(k.greatestFreq=m,k.mode=l);return k},{mode:null,greatestFreq:-Infinity,numMapping:{}}).mode;return{count:a,min:d,max:f,sum:g,mean:0===a?0:g/a,median:0===a?0:c[Math.floor(c.length/2)],mode:0===a?0:h}}})(vote||(vote={}));
