...
(function (permission) {
    ...
    function setModelPerms(key) {
        ...
        if (el) {
            const perms = group.findGroup(permission.permissions, key);
            ...
            group.findGroup(permission.permissions, key);
        }
    }
...
(function (permission) {
    function setProviderPerms(p) {
        const perms = group.findGroup(permission.permissions, p.key);
...
(function (system) {
    ...
    function onSystemMessage(cmd, param) {
        switch (cmd) {
            case command.server.error:
                rituals.onError(services.system.key, param);
                break;
