...
$jscomp.polyfill("WeakMap",function(a){function d(){if(!a||!Object.seal)return!1;try{var c=Object.seal({}),b=Object.seal({}),e=new a([[c,2],[b,3]]);if(2!=e.get(c)||3!=e.get(b))return!1;e.delete(c);e.set(b,4);return!e.has(c)&&4==e.get(b)}catch(p){return!1}}function c(){}function b(c){var a=typeof c;return"object"===a&&null!==c||"function"===a}function e(a){if(!$jscomp.owns(a,g)){var b=new c;$jscomp.defineProperty(a,g,{value:b})}}function f(a){var b=Object[a];b&&(Object[a]=function(a){if(a instanceof
c)return a;e(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(d())return a;var g="$jscomp_hidden_"+Math.random();f("freeze");f("preventExtensions");f("seal");var h=0,l=function(a){this.id_=(h+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};l.prototype.set=function(a,c){if(!b(a))throw Error("Invalid WeakMap key");e(a);if(!$jscomp.owns(a,g))throw Error("WeakMap key fail: "+
a);a[g][this.id_]=c;return this};l.prototype.get=function(a){return b(a)&&$jscomp.owns(a,g)?a[g][this.id_]:void 0};l.prototype.has=function(a){return b(a)&&$jscomp.owns(a,g)&&$jscomp.owns(a[g],this.id_)};l.prototype.delete=function(a){return b(a)&&$jscomp.owns(a,g)&&$jscomp.owns(a[g],this.id_)?delete a[g][this.id_]:!1};return l},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function d(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),b=new a($jscomp.makeIterator([[c,"s"]]));if("s"!=b.get(c)||1!=b.size||b.get({x:4})||b.set({x:4},"t")!=b||2!=b.size)return!1;var e=b.entries(),d=e.next();if(d.done||d.value[0]!=c||"s"!=d.value[1])return!1;d=e.next();return d.done||4!=d.value[0].x||"t"!=d.value[1]||!e.next().done?!1:!0}catch(p){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(d())return a;$jscomp.initSymbolIterator();var c=new WeakMap,b=function(a){this.data_={};this.head_=g();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};b.prototype.set=function(a,c){a=0===a?0:a;var b=e(this,a);b.list||(b.list=this.data_[b.id]=[]);b.entry?b.entry.value=c:(b.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,
value:c},b.list.push(b.entry),this.head_.previous.next=b.entry,this.head_.previous=b.entry,this.size++);return this};b.prototype.delete=function(a){a=e(this,a);return a.entry&&a.list?(a.list.splice(a.index,1),a.list.length||delete this.data_[a.id],a.entry.previous.next=a.entry.next,a.entry.next.previous=a.entry.previous,a.entry.head=null,this.size--,!0):!1};b.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=g();this.size=0};b.prototype.has=function(a){return!!e(this,a).entry};
b.prototype.get=function(a){return(a=e(this,a).entry)&&a.value};b.prototype.entries=function(){return f(this,function(a){return[a.key,a.value]})};b.prototype.keys=function(){return f(this,function(a){return a.key})};b.prototype.values=function(){return f(this,function(a){return a.value})};b.prototype.forEach=function(a,c){for(var b=this.entries(),e;!(e=b.next()).done;)e=e.value,a.call(c,e[1],e[0],this)};b.prototype[Symbol.iterator]=b.prototype.entries;var e=function(a,b){var e=b&&typeof b;"object"==
...
a.next=a.head=a},h=0;return b},"es6","es3");var rituals;(function(a){a.onError=function(a,c){console.error(a.key+": "+c);var b=c.lastIndexOf(":");-1<b&&(c=c.substr(b+1));notify.notify(a.key+" error: "+c,!1)};a.init=function(a,c){window.onbeforeunload=function(){socket.setAppUnloading()};socket.socketConnect(services.fromKey(a),c)}})(rituals||(rituals={}));var action;
...
(function(a){function d(a,b){a&&"modal"!==a||(a=g,b||(b=h));"root"===a&&(a="");return b?f.filter(function(c){return c.targetType===a&&c.targetID==b}):f.filter(function(b){return b.targetType===a})}function c(b,c){b&&"modal"!==b||(b=g,c||(c=h));b?(g=b,h=c,c=d(b,c),"root"!==b&&(b="modal"),b=dom.req("#drop-comment-"+b+" .uk-comment-list"),dom.setContent(b,a.renderComments(c,system.cache.getProfile())),b.scrollTop=b.scrollHeight):console.warn("invalid comment type ["+b+"]")}function b(){var a=dom.els(".comment-count-container"),
b=!1,c=dom.opt("#comment-count-modal");a.forEach(function(a){var f=a.dataset.commentType,k=a.dataset.commentId;if(!f)throw"invalid comment type ["+f+"] with id ["+k+"]";k=d(f,k);e(f,k,a);g===f&&c&&(e(f,k,c),b=!0)});!b&&c&&e("modal",[],c,!0)}function e(a,b,c,e){dom.req(".text",c).innerText=b.length.toString();"root"!==a&&"modal"!==a&&0!==a.length&&dom.setDisplay(c,0!==b.length||!0===e)}var f=[],g,h;a.applyComments=function(a){f=a};a.setActive=function(a,b){g=a;h=b};a.show=function(a){modal.open("comment",
a)};a.add=function(a){a=dom.req("#comment-add-content-"+a);var b=a.value;a.value="";socket.send({svc:services.system.key,cmd:command.client.addComment,param:{targetType:g,targetID:h,content:b}})};a.onCommentUpdate=function(a){f.push(a);b();c()};a.load=c;a.setCounts=b;a.closeModal=function(){"story"===g?modal.openSoon("story"):"report"===g?modal.openSoon("report"):"feedback"===g&&modal.openSoon("feedback");g=void 0};a.remove=function(a){confirm("remove this comment?")&&socket.send({svc:services.system.key,
cmd:command.client.removeComment,param:a});return!1};a.onCommentRemoved=function(a){f=f.filter(function(b){return b.id!==a});b();c()}})(comment||(comment={}));
(function(a){a.renderComments=function(a,c){return 0===a.length?JSX("div",null,"No comments available"):JSX("div",null,a.map(function(a){var b=a.userID===c.userID?JSX("div",{class:"right"},JSX("a",{class:c.linkColor+"-fg","data-uk-icon":"close",href:"",onclick:"return comment.remove('"+a.id+"');",title:"remove your comment"})):JSX("span",null);return JSX("li",null,JSX("article",{class:"uk-comment uk-visible-toggle uk-transition-toggle",tabindex:"-1"},member.renderHeader(member.getMember(a.userID),
a.created,b),JSX("div",{class:"uk-comment-body"},JSX("div",{dangerouslySetInnerHTML:{__html:a.html}})),JSX("hr",null)))}))};a.renderCount=function(a,c){var b=system.cache.getProfile();return JSX("div",{class:"comment-count-container uk-margin-small-left left hidden","data-comment-type":a,"data-comment-id":c},JSX("a",{class:b.linkColor+"-fg",title:"view comments"},JSX("div",{class:"comment-count"},JSX("span",{class:"uk-icon","data-uk-icon":"comment"}),JSX("span",{class:"text"}))))}})(comment||(comment=
...
a.slug},a.title)),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},date.toDateTimeString(new Date(a.created))))})))}})(contents||(contents={}));var estimate;
...
break;case command.server.storyStatusChange:story.onStoryStatusChange(f);break;case command.server.voteUpdate:vote.onVoteUpdate(f);break;default:console.warn("unhandled command ["+e+"] for estimate")}};a.onSubmitEstimateSession=function(){var a=dom.req("#model-title-input").value,b=dom.req("#model-choices-input").value,c=dom.req("#model-team-select select").value,e=dom.req("#model-sprint-select select").value,d=permission.readPermissions();socket.send({svc:services.estimate.key,cmd:command.client.updateSession,
param:{title:a,choices:b,teamID:c,sprintID:e,permissions:d}})};a.onStoryUpdate=c;a.onStoryRemove=b})(estimate||(estimate={}));var feedback;
...
a.renderFeedbackArray(b));comment.setCounts();modal.hide("add-feedback")};a.onSubmitFeedback=function(){var a=dom.req("#feedback-category").value,b=dom.req("#feedback-content").value;socket.send({svc:services.retro.key,cmd:command.client.addFeedback,param:{category:a,content:b}});return!1};a.onEditFeedback=function(){var a=retro.cache.activeFeedback,b=dom.req("#feedback-edit-category").value,c=dom.req("#feedback-edit-content").value;socket.send({svc:services.retro.key,cmd:command.client.updateFeedback,
param:{id:a,category:b,content:c}});return!1};a.onRemoveFeedback=function(){var a=retro.cache.activeFeedback;a&&UIkit.modal.confirm("Delete this feedback?").then(function(){socket.send({svc:services.retro.key,cmd:command.client.removeFeedback,param:a});modal.hide("feedback")});return!1};a.getActiveFeedback=d;a.viewActiveFeedback=function(a){var b,c=system.cache.getProfile();a&&(retro.cache.activeFeedback=a);(a=d())?(c=a.userID===c.userID,dom.setText("#feedback-title",a.category+" / "+(null===(b=member.getMember(a.userID))||
...
(function(a){function d(a){return a.userID===system.cache.getProfile().userID}function c(){var c=g.filter(d).shift();c&&(h=c,dom.setContent("#self-picture",a.setPicture(c.picture)),dom.setText("#member-self .member-name",c.name),dom.setValue("#self-name-input",c.name),dom.setText("#member-self .member-role",c.role));c=g.filter(function(a){return!d(a)});dom.setContent("#member-detail",a.renderMembers(c));0<c.length&&modal.hide("welcome");b()}function b(){for(var a={},b=$jscomp.makeIterator(g),c=b.next();!c.done;a=
{$jscomp$loop$prop$member$6$10:a.$jscomp$loop$prop$member$6$10},c=b.next())a.$jscomp$loop$prop$member$6$10=c.value,(c=dom.opt("#member-"+a.$jscomp$loop$prop$member$6$10.userID+" .online-indicator"))&&(f.find(function(a){return function(b){return b===a.$jscomp$loop$prop$member$6$10.userID}}(a))?c.classList.remove("offline"):c.classList.add("offline"))}function e(){if(l){var a=g.filter(function(a){return a.userID===l}).shift();a||console.warn("cannot load active member ["+l+"]");return a}console.warn("no active member")}
var f=[],g=[],h;a.getMembers=function(){return g};a.getMember=function(a){return g.filter(function(b){return b.userID===a}).shift()};a.setMembers=c;a.onMemberRemove=function(a){var b;a===system.cache.getProfile().userID?(notify.notify("you have left this "+(null===(b=system.cache.currentService)||void 0===b?void 0:b.key),!0),document.location.href="/"):(modal.hide("member"),b=g.filter(function(b){return b.userID!==a}),b.sort(function(a,b){return a.name>b.name?1:-1}),g=b,c())};a.onMemberUpdate=function(a){d(a)?
(h=a,modal.hide("self")):modal.hide("member");var b=g,e=b.filter(function(b){return b.userID===a.userID}).shift();e=(null===e||void 0===e?void 0:e.name)!==a.name;b=b.filter(function(b){return b.userID!==a.userID});b.length===g.length&&notify.notify(a.name+" has joined",!0);b.push(a);b.sort(function(a,b){return a.name>b.name?1:-1});g=b;c();if(e)switch(system.cache.currentService){case services.estimate:estimate.cache.activeStory&&vote.viewVotes();break;case services.standup:dom.setContent("#report-detail",
report.renderReports(standup.cache.reports));standup.cache.activeReport&&report.viewActiveReport();break;case services.retro:dom.setContent("#feedback-detail",feedback.renderFeedbackArray(retro.cache.feedback)),retro.cache.activeFeedback&&feedback.viewActiveFeedback()}};a.onOnlineUpdate=function(a){a.connected?f.find(function(b){return b===a.userID})||f.push(a.userID):f=f.filter(function(b){return b!==a.userID});b()};a.onSubmitSelf=function(){var a=dom.req("#self-name-input").value,b=dom.req("#self-name-choice-global").checked?
"global":"local",c=dom.req("#self-picture-input").value;socket.send({svc:services.system.key,cmd:command.client.updateProfile,param:{name:a,choice:b,picture:c}})};var l;a.viewActiveMember=function(a){a&&(l=a);if(a=e()){var b="owner"==(null===h||void 0===h?void 0:h.role);dom.setDisplay("#modal-member .owner-form",b);dom.setDisplay("#modal-member .member-form",!b);dom.setDisplay("#modal-member .owner-actions",b);dom.setDisplay("#modal-member .member-actions",!b);dom.setSelectOption("#member-modal-role-select",
a.role);dom.setText("#member-modal-name",a.name);dom.setText("#member-modal-role",a.role)}};a.removeMember=function(a){(a=void 0===a?l:a)||console.warn("cannot load active member ["+l+"]");"self"===a&&(a=system.cache.getProfile().userID);var b=system.cache.currentService;confirm("Are you sure you wish to leave this "+b.key+"?")&&socket.send({svc:b.key,cmd:command.client.removeMember,param:a})};a.saveRole=function(){var a=e();if(a){var b=a.role,c=dom.req("#member-modal-role-select").value;b===c?modal.hide("member"):
socket.send({svc:system.cache.currentService.key,cmd:command.client.updateMember,param:{id:a.userID,role:c}})}else console.warn("no active member")};a.applyMembers=function(a){g=a};a.applyOnline=function(a){f=a}})(member||(member={}));
...
JSX("span",{class:"model-icon h3-icon",onclick:"modal.open('self');","data-uk-icon":"icon: user;"})}})(member||(member={}));var command;
...
(function(a){function d(a){var b=dom.opt("#model-"+a+"-select select");if(b){var c=collection.findGroup(e,a),d=dom.opt("#perm-"+a+"-section");d&&(dom.req("#perm-"+a+"-checkbox").checked=0<c.length,dom.setDisplay(d,0!==b.value.length));collection.findGroup(e,a)}}function c(a,b){dom.els(".perm-"+a+"-email").forEach(function(a){a.disabled=!b;b||(a.checked=!1)})}function b(b){var c=collection.findGroup(e,b.key),d=auth.active().filter(function(a){return a.provider===b.key});if(dom.opt("#perm-"+b.key+"-section")){dom.req("#perm-"+
b.key+"-checkbox").checked=0<c.length;var f=dom.req("#perm-"+b.key+"-email-container"),k=collection.flatten(c.map(function(a){return a.v.split(",").filter(function(a){return 0<a.length})})).map(function(a){return{matched:!0,domain:a}});c=d.filter(function(a){return 0===k.filter(function(b){return a.email.endsWith(b.domain)}).length}).map(function(a){a=a.email;var b=a.lastIndexOf("@");a=-1===b?a:a.substr(b);return{matched:!1,domain:a}});k.push.apply(k,$jscomp.arrayFromIterable(c));k.sort();dom.setDisplay(f,
0<k.length);dom.setContent(f,0===k.length?document.createElement("span"):a.renderEmails(b.key,k))}}var e=[];a.setPerms=function(){dom.setDisplay("#public-link-container",null===e||0===e.length);dom.setDisplay("#private-link-container",null!==e&&0<e.length);["team","sprint"].forEach(d);auth.allProviders.forEach(b)};a.setModelPerms=d;a.onChanged=function(a,b,e){switch(a){case "email":(a=dom.opt("#perm-"+b+"-checkbox"))&&e&&!a.checked&&(a.checked=!0);break;case "provider":return c(b,e)}};a.applyPermissions=
...
break;case command.server.feedbackUpdate:feedback.onFeedbackUpdate(b);break;case command.server.feedbackRemove:feedback.onFeedbackRemoved(b);break;default:console.warn("unhandled command ["+c+"] for retro")}};a.onSubmitRetroSession=function(){var a=dom.req("#model-title-input").value,b=dom.req("#model-categories-input").value,e=dom.req("#model-team-select select").value,d=dom.req("#model-sprint-select select").value,g=permission.readPermissions();socket.send({svc:services.retro.key,cmd:command.client.updateSession,
param:{title:a,categories:b,teamID:e,sprintID:d,permissions:g}})}})(retro||(retro={}));var session;
(function(a){a.setDetail=function(a){var c,b=(null===(c=system.cache.session)||void 0===c?void 0:c.slug)||"invalid";system.cache.session=a;document.title=a.title;dom.setText("#model-title",a.title);dom.setValue("#model-title-input",a.title);c=dom.els("#navbar .uk-navbar-item");0<c.length&&(c[c.length-1].innerText=a.title);b!==a.slug&&(window.history.replaceState(null,"",document.location.href.replace(b,a.slug)),console.log("slugChanged!!!!!"));modal.hide("session")};a.onSessionJoin=function(a){system.cache.apply(a);
permission.setPerms();member.setMembers();comment.setCounts()};a.showWelcomeMessage=function(a){1===a&&setTimeout(function(){return modal.open("welcome")},300)};a.setSprint=function(a){modal.hide("session");var c=dom.req("#sprint-link-container");c.innerHTML="";a&&(c.appendChild(sprint.renderSprintLink(a)),dom.req("#sprint-warning-name").innerText=a.title)};a.setTeam=function(a){modal.hide("session");var c=dom.req("#team-link-container");c.innerHTML="";a&&c.appendChild(team.renderTeamLink(a))};a.onModalOpen=
function(a){var c=dom.setValue("#model-title-input",dom.req("#model-title").innerText);setTimeout(function(){return c.focus()},250);team.refreshTeams();sprint.refreshSprints()}})(session||(session={}));var socket;
...
(function(a){function d(a,b){return UIkit.util.$$(a,b)}function c(a,b){b=d(a,b);switch(b.length){case 0:break;case 1:return b[0];default:console.warn("found ["+b.length+"] elements with selector ["+a+"], wanted zero or one")}}function b(a,b){(b=c(a,b))||console.warn("no element found for selector ["+a+"]");return b}a.initDom=function(a,b){try{style.themeLinks(b),style.setTheme(a)}catch(g){console.warn("error setting style",g)}try{modal.wire()}catch(g){console.warn("error wiring modals",g)}};a.els=
d;a.opt=c;a.req=b;a.setHTML=function(a,c){"string"===typeof a&&(a=b(a));a.innerHTML=c;return a};a.setDisplay=function(a,c,d){d=void 0===d?"block":d;"string"===typeof a&&(a=b(a));a.style.display=c?d:"none";return a};a.setContent=function(a,c){"string"===typeof a&&(a=b(a));a.innerHTML="";a.appendChild(c);return a};a.setText=function(a,c){"string"===typeof a&&(a=b(a));a.innerText=c;return a}})(dom||(dom={}));
...
function(d,c){"string"===typeof d&&(d=a.req(d));d.innerHTML="";c=$jscomp.makeIterator(c);for(var b=c.next();!b.done;b=c.next()){b=b.value;var e=document.createElement("option");e.value=b;e.innerText=b;d.appendChild(e)}};a.setSelectOption=function(d,c){"string"===typeof d&&(d=a.req(d));for(var b=0;b<d.children.length;b++){var e=d.children.item(b);e.selected=e.value===c}};a.insertAtCaret=function(a,c){if(a.selectionStart||0===a.selectionStart){var b=a.selectionStart,d=a.selectionEnd;a.value=a.value.substring(0,
b)+c+a.value.substring(d,a.value.length);a.selectionStart=b+c.length;a.selectionEnd=b+c.length}else a.value+=c}})(dom||(dom={}));
function JSX(a,d){var c=document.createElement(a),b;for(b in d)if(b&&d.hasOwnProperty(b)){var e=d[b];"dangerouslySetInnerHTML"===b?c.innerHTML=e.__html:!0===e?c.setAttribute(b,b):!1!==e&&null!==e&&void 0!==e&&c.setAttribute(b,e.toString())}for(b=2;b<arguments.length;b++)if(e=arguments[b],Array.isArray(e))e.forEach(function(a){c.appendChild(a)});else{if(void 0===e||null===e)throw"child for tag ["+a+"] is "+e;e.nodeType||(e=document.createTextNode(e.toString()));c.appendChild(e)}return c}var modal;
(function(a){function d(a,b,c){b||(b=function(){});l.set(a,b);c&&k.set(a,c)}function c(a,b){m=b;(b=UIkit.modal("#modal-"+a))||console.warn("no modal available with key ["+a+"]");b.show();return!1}function b(a){if(a.target&&(a=a.target,0===a.id.indexOf("modal"))){a=a.id.substr(6);var b=l.get(a);b?b(m):console.warn("no modal open handler registered for ["+a+"]");m=void 0}}function e(a){a.target&&(a=a.target,a.classList.contains("uk-open")&&(a=a.id.substr(6),(a=k.get(a))&&a(m),m=void 0))}function f(a){if(a.target){var b=
a.target;a=b.dataset.key||"";b=b.dataset.t||"";var c=l.get(a);c?c(b):console.warn("no modal open handler registered for ["+a+"]")}}function g(a){if(a.target){var b=a.target;b.classList.contains("uk-open")&&(a=b.dataset.t||"",(b=k.get(b.dataset.key||""))&&b(a))}}function h(a){n&&a.preventDefault()}var l=new Map,k=new Map,m;a.register=d;a.wire=function(){UIkit.util.on(".drop","show",f);UIkit.util.on(".drop","beforehide",h);UIkit.util.on(".drop","hide",g);UIkit.util.on(".modal","show",b);UIkit.util.on(".modal",
