...
cmd:command.client.addComment,param:{targetType:g,targetID:h,content:b}})};a.onCommentUpdate=function(a){f.push(a);b();c()};a.load=c;a.setCounts=b;a.closeModal=function(){"story"===g?modal.openSoon("story"):"report"===g?modal.openSoon("report"):"feedback"===g&&modal.openSoon("feedback");g=void 0}})(comment||(comment={}));
...
(function(a){function d(a){return a.userID===system.cache.getProfile().userID}function c(){var c=g.filter(d).shift();c&&(dom.setContent("#self-picture",a.setPicture(c.picture)),dom.setText("#member-self .member-name",c.name),dom.setValue("#self-name-input",c.name),dom.setText("#member-self .member-role",c.role));c=g.filter(function(a){return!d(a)});dom.setContent("#member-detail",a.renderMembers(c));b()}function b(){for(var a={},b=$jscomp.makeIterator(g),c=b.next();!c.done;a={$jscomp$loop$prop$member$6$10:a.$jscomp$loop$prop$member$6$10},
