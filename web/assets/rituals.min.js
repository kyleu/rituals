...
$jscomp.polyfill("WeakMap",function(a){function d(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),e=new a([[b,2],[c,3]]);if(2!=e.get(b)||3!=e.get(c))return!1;e.delete(b);e.set(c,4);return!e.has(b)&&4==e.get(c)}catch(p){return!1}}function c(){}function b(b){var a=typeof b;return"object"===a&&null!==b||"function"===a}function e(b){if(!$jscomp.owns(b,g)){var a=new c;$jscomp.defineProperty(b,g,{value:a})}}function f(b){var a=Object[b];a&&(Object[b]=function(b){if(b instanceof
...
b.next=b.head=b},h=0;return b},"es6","es3");var rituals;(function(a){a.onError=function(a,c){console.error(a.key+": "+c);var b=c.lastIndexOf(":");-1<b&&(c=c.substr(b+1));notify.notify(a.key+" error: "+c,!1)};a.init=function(a,c){window.onbeforeunload=function(){socket.setAppUnloading()};socket.socketConnect(services.fromKey(a),c)}})(rituals||(rituals={}));var action;
...
(function(a){function d(b,a){b&&"modal"!==b||(b=g,a||(a=h));"root"===b&&(b="");return a?f.filter(function(c){return c.targetType===b&&c.targetID==a}):f.filter(function(a){return a.targetType===b})}function c(b,c){b&&"modal"!==b||(b=g,c||(c=h));b?(g=b,h=c,c=d(b,c),"root"!==b&&(b="modal"),b=dom.req("#drop-comment-"+b+" .uk-comment-list"),dom.setContent(b,a.renderComments(c,system.cache.getProfile())),b.scrollTop=b.scrollHeight):console.warn("invalid comment type ["+b+"]")}function b(){var b=dom.els(".comment-count-container"),
a=!1,c=dom.opt("#comment-count-modal");b.forEach(function(b){var f=b.dataset.commentType,h=b.dataset.commentId;if(!f)throw"invalid comment type ["+f+"] with id ["+h+"]";h=d(f,h);e(f,h,b);g===f&&c&&(e(f,h,c),a=!0)});!a&&c&&e("modal",[],c,!0)}function e(b,a,c,e){dom.setText(dom.req(".text",c),a.length.toString());"root"!==b&&"modal"!==b&&0!==b.length&&dom.setDisplay(c,0!==a.length||!0===e)}var f=[],g,h;a.applyComments=function(b){f=b};a.setActive=function(b,a){g=b;h=a};a.show=function(b){modal.open("comment",
b)};a.add=function(b){b=dom.req("#comment-add-content-"+b);var a=b.value;b.value="";socket.send({svc:services.system.key,cmd:command.client.addComment,param:{targetType:g,targetID:h,content:a}})};a.onCommentUpdate=function(a){f.push(a);b();c()};a.load=c;a.setCounts=b;a.closeModal=function(){"story"===g?modal.openSoon("story"):"report"===g?modal.openSoon("report"):"feedback"===g&&modal.openSoon("feedback");g=void 0};a.remove=function(b){confirm("remove this comment?")&&socket.send({svc:services.system.key,
cmd:command.client.removeComment,param:b});return!1};a.onCommentRemoved=function(a){f=f.filter(function(b){return b.id!==a});b();c()}})(comment||(comment={}));
(function(a){a.renderComments=function(a,c){return 0===a.length?JSX("div",null,"No comments available"):JSX("div",null,a.map(function(b){var a=b.userID===c.userID?JSX("div",{class:"right"},JSX("a",{class:c.linkColor+"-fg","data-uk-icon":"close",href:"",onclick:"return comment.remove('"+b.id+"');",title:"remove your comment"})):JSX("span",null);return JSX("li",null,JSX("article",{class:"uk-comment uk-visible-toggle uk-transition-toggle",tabindex:"-1"},member.renderHeader(member.getMember(b.userID),
b.created,a),JSX("div",{class:"uk-comment-body"},JSX("div",{dangerouslySetInnerHTML:{__html:b.html}})),JSX("hr",null)))}))};a.renderCount=function(a,c){var b=system.cache.getProfile();return JSX("div",{class:"comment-count-container uk-margin-small-left left hidden","data-comment-type":a,"data-comment-id":c},JSX("a",{class:b.linkColor+"-fg",title:"view comments"},JSX("div",{class:"comment-count"},JSX("span",{class:"uk-icon","data-uk-icon":"comment"}),JSX("span",{class:"text"}))))}})(comment||(comment=
{}));var contents;(function(a){a.onContentDisplay=function(a,c,b,e){dom.setDisplay("#modal-"+a+" .content-edit",c);dom.setDisplay("#modal-"+a+" .buttons-edit",c);var d=dom.setDisplay("#modal-"+a+" .content-view",!c);dom.setHTML(d,c?"":e);dom.setDisplay("#modal-"+a+" .buttons-view",!c);a=dom.req("#"+a+"-edit-content");dom.setValue(a,c?b:"");c&&dom.wireTextarea(a)}})(contents||(contents={}));
...
b.slug},b.title)),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},date.toDateTimeString(new Date(b.created))))})))}})(contents||(contents={}));var estimate;
(function(a){function d(b){a.cache.detail=b;var c=b.choices.join(", ");dom.setValue("#model-choices-input",c);dom.setText("#session-view-section .choices",c);story.viewActiveStory();session.setDetail(b)}function c(b){var c=e(b.id);c.push(b);c.sort(function(b){return b.idx});b.id===a.cache.activeStory&&dom.setText("#story-title",b.title);story.setStories(c)}function b(b){var c=e(b);story.setStories(c);b===a.cache.activeStory&&modal.hide("story");notify.notify("story has been deleted",!0)}function e(b){return a.cache.stories.filter(function(a){return a.id!==
b})}var f=function(){this.stories=[];this.votes=[]};f.prototype.activeVotes=function(){var b=this;return this.activeStory?this.votes.filter(function(a){return a.storyID===b.activeStory}):[]};a.cache=new f;a.onEstimateMessage=function(e,f){switch(e){case command.server.error:rituals.onError(services.estimate,f);break;case command.server.sessionJoined:session.onSessionJoin(f);d(f.session);story.setStories(f.stories);vote.setVotes(f.votes);session.showWelcomeMessage(f.members.length);break;case command.server.sessionUpdate:d(f);
break;case command.server.sessionRemove:system.onSessionRemove(services.estimate);break;case command.server.permissionsUpdate:system.setPermissions(f);break;case command.server.teamUpdate:a.cache.detail&&(a.cache.detail.teamID=null===f||void 0===f?void 0:f.id);session.setTeam(f);break;case command.server.sprintUpdate:a.cache.detail&&(a.cache.detail.sprintID=null===f||void 0===f?void 0:f.id);session.setSprint(f);break;case command.server.storyUpdate:c(f);break;case command.server.storyRemove:b(f);
break;case command.server.storyStatusChange:story.onStoryStatusChange(f);break;case command.server.voteUpdate:vote.onVoteUpdate(f);break;default:console.warn("unhandled command ["+e+"] for estimate")}};a.onSubmitEstimateSession=function(){var b=dom.req("#model-title-input").value,a=dom.req("#model-choices-input").value,c=dom.req("#model-team-select select").value,e=dom.req("#model-sprint-select select").value,d=permission.readPermissions();socket.send({svc:services.estimate.key,cmd:command.client.updateSession,
param:{title:b,choices:a,teamID:c,sprintID:e,permissions:d}})};a.onStoryUpdate=c;a.onStoryRemove=b})(estimate||(estimate={}));var feedback;
(function(a){function d(){if(retro.cache.activeFeedback){var b=retro.cache.feedback.filter(function(b){return b.id===retro.cache.activeFeedback}).shift();b||console.warn("cannot load active Feedback ["+retro.cache.activeFeedback+"]");return b}}function c(b){return retro.cache.feedback.filter(function(a){return a.id!==b})}function b(b,a){feedback.setFeedback(b);a===retro.cache.activeFeedback&&modal.hide("feedback")}a.setFeedback=function(b){retro.cache.feedback=b;dom.setContent("#feedback-detail",
a.renderFeedbackArray(b));comment.setCounts();modal.hide("add-feedback")};a.onSubmitFeedback=function(){var b=dom.req("#feedback-category").value,a=dom.req("#feedback-content").value;socket.send({svc:services.retro.key,cmd:command.client.addFeedback,param:{category:b,content:a}});return!1};a.onEditFeedback=function(){var b=retro.cache.activeFeedback,a=dom.req("#feedback-edit-category").value,c=dom.req("#feedback-edit-content").value;socket.send({svc:services.retro.key,cmd:command.client.updateFeedback,
param:{id:b,category:a,content:c}});return!1};a.onRemoveFeedback=function(){var b=retro.cache.activeFeedback;b&&UIkit.modal.confirm("Delete this feedback?").then(function(){socket.send({svc:services.retro.key,cmd:command.client.removeFeedback,param:b});modal.hide("feedback")});return!1};a.getActiveFeedback=d;a.viewActiveFeedback=function(b){var a,c=system.cache.getProfile();b&&(retro.cache.activeFeedback=b);(b=d())?(c=b.userID===c.userID,dom.setText("#feedback-title",b.category+" / "+(null===(a=member.getMember(b.userID))||
void 0===a?void 0:a.name)),dom.setSelectOption("#feedback-edit-category",c?b.category:void 0),contents.onContentDisplay("feedback",c,b.content,b.html),comment.setActive("feedback",b.id),comment.setCounts()):console.warn("no active feedback")};a.onFeedbackUpdate=function(a){var e=c(a.id);e.push(a);b(e,a.id)};a.onFeedbackRemoved=function(a){var e=c(a);b(e,a);notify.notify("feedback has been deleted",!0)};a.getFeedbackCategories=function(b,a){var c=a.map(function(a){var c=b.filter(function(b){return b.category===
a}).sort(function(b,a){return b.created>a.created?-1:1});return{category:a,feedback:c}}),e=b.filter(function(b){return!a.find(function(a){return a===b.category})});0<e.length&&c.push({category:"unknown",feedback:e});return c};a.viewAddFeedback=function(b){dom.setSelectOption("#feedback-category",b);var a=dom.setValue("#feedback-content","");dom.wireTextarea(a);setTimeout(function(){return a.focus()},250)};a.viewFeedback=function(b){feedback.viewActiveFeedback(b);var a=dom.req("#feedback-edit-content");
setTimeout(function(){dom.wireTextarea(a);a.focus()},250)}})(feedback||(feedback={}));
...
JSX("div",{class:"feedback-category-header"},JSX("span",{class:"right"},JSX("a",{class:b.linkColor+"-fg uk-icon-button uk-transition-fade","data-uk-icon":"plus",onclick:"modal.open('add-feedback', '"+a.category+"');",title:"add feedback"})),JSX("span",{class:"feedback-category-title",onclick:"modal.open('add-feedback', '"+a.category+"');"},a.category)),JSX("div",null,a.feedback.map(function(b){var a=system.cache.getProfile();a=JSX("div",{id:"feedback-"+b.id,class:"feedback-detail section",onclick:"modal.open('feedback', '"+
b.id+"');"},JSX("div",{class:"feedback-comments right"},comment.renderCount("feedback",b.id)),JSX("div",{class:"left"},JSX("a",{class:a.linkColor+"-fg section-link"},member.renderTitle(member.getMember(b.userID)))),JSX("div",{class:"clear"}),JSX("div",{class:"feedback-content"},"loading..."));0<b.html.length&&(dom.setHTML(dom.req(".feedback-content",a),b.html).style.display="block");return JSX("div",null,a)})))}))}})(feedback||(feedback={}));var member;
...
(function(a){function d(){a.updateSelf(b.filter(a.isSelf).shift());var c=b.filter(function(b){return!a.isSelf(b)});dom.setContent("#member-detail",a.renderMembers(c));0<c.length&&modal.hide("welcome");a.renderOnline()}function c(){if(e){var a=b.filter(function(b){return b.userID===e}).shift();a||console.warn("cannot load active member ["+e+"]");return a}console.warn("no active member")}var b=[],e;a.getMember=function(a){return b.filter(function(b){return b.userID===a}).shift()};a.getMembers=function(){return b};
a.setMembers=d;a.onMemberUpdate=function(c){a.isSelf(c)?modal.hide("self"):modal.hide("member");var e=b,f=e.filter(function(b){return b.userID===c.userID}).shift();f=(null===f||void 0===f?void 0:f.name)!==c.name;e=e.filter(function(b){return b.userID!==c.userID});e.length===b.length&&notify.notify(c.name+" has joined",!0);e.push(c);e.sort(function(b,a){return b.name>a.name?1:-1});b=e;d();a.memberUpdateDom(f)};a.onMemberRemove=function(a){var c;a===system.cache.getProfile().userID?(notify.notify("you have left this "+
(null===(c=system.cache.currentService)||void 0===c?void 0:c.key),!0),document.location.href="/"):(modal.hide("member"),c=b.filter(function(b){return b.userID!==a}),c.sort(function(b,a){return b.name>a.name?1:-1}),b=c,d())};a.viewActiveMember=function(b){b&&(e=b);(b=c())&&a.activeMemberDom(b)};a.removeMember=function(b){(b=void 0===b?e:b)||console.warn("cannot load active member ["+e+"]");"self"===b&&(b=system.cache.getProfile().userID);var a=system.cache.currentService;confirm("Are you sure you wish to leave this "+
a.key+"?")&&socket.send({svc:a.key,cmd:command.client.removeMember,param:b})};a.saveRole=function(){var b=c();if(b){var a=b.role,e=dom.req("#member-modal-role-select").value;a===e?modal.hide("member"):socket.send({svc:system.cache.currentService.key,cmd:command.client.updateMember,param:{id:b.userID,role:e}})}else console.warn("no active member")};a.applyMembers=function(a){b=a}})(member||(member={}));
(function(a){function d(a){return a?a.picture&&0<a.picture.length&&"none"!=a.picture?JSX("div",null,JSX("div",{class:"profile-image"},JSX("img",{class:"uk-border-circle",src:a.picture,alt:a.name})),JSX("div",{class:"left"},a.name),JSX("div",{class:"clear"})):JSX("div",null,JSX("div",{class:"profile-image"},JSX("span",{class:"profile-icon uk-icon","data-uk-icon":"user"})),JSX("div",{class:"left"},a.name)):JSX("span",null,"{former member}")}a.renderMembers=function(a){return 0===a.length?JSX("div",
null,JSX("button",{class:"uk-button uk-button-default",onclick:"modal.open('invitation');",type:"button"},"Invite Members")):JSX("ul",{class:"uk-list uk-list-divider"},a.map(function(b){var a={id:"member-"+b.userID},c=system.cache.getProfile();b=JSX("div",{class:"section",onclick:"modal.open('member', '"+b.userID+"');"},JSX("div",{title:"user is offline",class:"right uk-article-meta online-indicator"},"offline"),JSX("div",{class:c.linkColor+"-fg section-link"},d(b)));return JSX("li",a,b)}))};a.renderTitle=
d;a.renderHeader=function(a,b,e){return JSX("header",{class:"uk-comment-header uk-position-relative"},e?e:JSX("span",null),JSX("div",{class:"uk-grid-collapse uk-flex-middle","uk-grid":!0},JSX("div",{class:"uk-width-auto"},a&&a.picture&&0<a.picture.length?JSX("div",null,JSX("div",{class:"profile-image"},JSX("img",{class:"uk-border-circle",src:a.picture,alt:a.name}))):JSX("div",null,JSX("div",{class:"profile-image"},JSX("span",{class:"profile-icon uk-icon","data-uk-icon":"user"})))),JSX("div",{class:"uk-width-expand"},
JSX("h4",{class:"uk-comment-title uk-margin-remove"},null===a||void 0===a?void 0:a.name),JSX("p",{class:"uk-comment-meta uk-margin-remove-top"},date.toDateTimeString(new Date(b))))))};a.viewSelf=function(){var a=dom.setValue("#self-name-input",dom.req("#member-self .member-name").innerText);setTimeout(function(){return a.focus()},250)};a.setPicture=function(a){return a&&0<a.length&&"none"!=a?JSX("div",{class:"model-icon profile-image"},JSX("img",{class:"uk-border-circle",src:a,alt:"your picture"})):
JSX("span",{class:"model-icon h3-icon",onclick:"modal.open('self');","data-uk-icon":"icon: user;"})}})(member||(member={}));
(function(a){function d(){for(var b={},e=$jscomp.makeIterator(a.getMembers()),d=e.next();!d.done;b={$jscomp$loop$prop$member$7$12:b.$jscomp$loop$prop$member$7$12},d=e.next())b.$jscomp$loop$prop$member$7$12=d.value,(d=dom.opt("#member-"+b.$jscomp$loop$prop$member$7$12.userID+" .online-indicator"))&&(c.find(function(b){return function(a){return a===b.$jscomp$loop$prop$member$7$12.userID}}(b))?d.classList.remove("offline"):d.classList.add("offline"))}var c=[];a.onOnlineUpdate=function(b){b.connected?
c.find(function(a){return a===b.userID})||c.push(b.userID):c=c.filter(function(a){return a!==b.userID});d()};a.applyOnline=function(b){c=b};a.renderOnline=d})(member||(member={}));
...
(function(a){function d(b){var c=dom.opt("#model-"+b+"-select select");if(c){var d=collection.findGroup(a.permissions,b),g=dom.opt("#perm-"+b+"-section");g&&(dom.req("#perm-"+b+"-checkbox").checked=0<d.length,dom.setDisplay(g,0!==c.value.length));collection.findGroup(a.permissions,b)}}function c(b){var a=dom.opt("#perm-"+b+"-checkbox");if(!a||!a.checked)return[];a=dom.els(".perm-"+b+"-email").filter(function(b){return b.checked}).map(function(b){return b.value}).join(",");return[{k:b,v:a,access:"member"}]}
a.permissions=[];a.applyPermissions=function(b){a.permissions=collection.groupBy(b,function(b){return b.k}).groups};a.setPerms=function(){var b=null===a.permissions||0===a.permissions.length;dom.setDisplay("#public-link-container",b);dom.setDisplay("#private-link-container",!b);a.updateView();["team","sprint"].forEach(d);auth.allProviders.forEach(a.setProviderPerms)};a.setModelPerms=d;a.readPermissions=function(){var b=[];b.push.apply(b,$jscomp.arrayFromIterable(c("team")));b.push.apply(b,$jscomp.arrayFromIterable(c("sprint")));
b.push.apply(b,$jscomp.arrayFromIterable(c("github")));b.push.apply(b,$jscomp.arrayFromIterable(c("google")));b.push.apply(b,$jscomp.arrayFromIterable(c("slack")));b.push.apply(b,$jscomp.arrayFromIterable(c("facebook")));b.push.apply(b,$jscomp.arrayFromIterable(c("amazon")));b.push.apply(b,$jscomp.arrayFromIterable(c("microsoft")));return b}})(permission||(permission={}));
(function(a){a.renderEmails=function(a,c){var b="uk-checkbox uk-margin-small-right perm-"+a+"-email",d="permission.onChanged('email', '"+a+"', this.checked)";return JSX("ul",null,c.map(function(a){return JSX("li",null,JSX("label",null,a.matched?JSX("input",{class:b,type:"checkbox",value:a.domain,checked:"checked",onchange:d}):JSX("input",{class:b,type:"checkbox",value:a.domain,onchange:d}),"Using email address ",a.domain))}))}})(permission||(permission={}));
(function(a){function d(a,b){dom.els(".perm-"+a+"-email").forEach(function(a){a.disabled=!b;b||(a.checked=!1)})}a.setProviderPerms=function(c){var b=collection.findGroup(a.permissions,c.key),d=auth.active().filter(function(b){return b.provider===c.key});if(dom.opt("#perm-"+c.key+"-section")){dom.req("#perm-"+c.key+"-checkbox").checked=0<b.length;var f=dom.req("#perm-"+c.key+"-email-container"),g=collection.flatten(b.map(function(b){return b.v.split(",").filter(function(b){return 0<b.length})})).map(function(b){return{matched:!0,
domain:b}});b=d.filter(function(b){return 0===g.filter(function(a){return b.email.endsWith(a.domain)}).length}).map(function(b){b=b.email;var a=b.lastIndexOf("@");b=-1===a?b:b.substr(a);return{matched:!1,domain:b}});g.push.apply(g,$jscomp.arrayFromIterable(b));g.sort();dom.setDisplay(f,0<g.length);dom.setContent(f,0===g.length?document.createElement("span"):a.renderEmails(c.key,g))}};a.onChanged=function(a,b,e){switch(a){case "email":(a=dom.opt("#perm-"+b+"-checkbox"))&&e&&!a.checked&&(a.checked=
!0);break;case "provider":return d(b,e)}}})(permission||(permission={}));(function(a){a.updateView=function(){var a=dom.opt("#session-view-section .perms");a&&dom.setHTML(a,"<div>Foooooooooooo</div>")}})(permission||(permission={}));var report;
(function(a){function d(){if(standup.cache.activeReport){var a=standup.cache.reports.filter(function(b){return b.id===standup.cache.activeReport}).shift();a||console.warn("cannot load active report ["+standup.cache.activeReport+"]");return a}console.warn("no active report")}a.onSubmitReport=function(){var a=dom.req("#report-date").value,b=dom.req("#report-content").value;socket.send({svc:services.standup.key,cmd:command.client.addReport,param:{d:a,content:b}});return!1};a.onEditReport=function(){var a=
...
(report={}));var retro;
(function(a){function d(c){a.cache.detail=c;var b=c.categories.join(", ");dom.setValue("#model-categories-input",b);dom.setText("#session-view-section .categories",b);dom.setOptions("#feedback-category",c.categories);dom.setOptions("#feedback-edit-category",c.categories);feedback.setFeedback(a.cache.feedback);session.setDetail(c)}a.cache=new function(){this.feedback=[]};a.onRetroMessage=function(c,b){switch(c){case command.server.error:rituals.onError(services.retro,b);break;case command.server.sessionJoined:session.onSessionJoin(b);
d(b.session);feedback.setFeedback(b.feedback);session.showWelcomeMessage(b.members.length);break;case command.server.sessionUpdate:d(b);break;case command.server.sessionRemove:system.onSessionRemove(services.retro);break;case command.server.permissionsUpdate:system.setPermissions(b);break;case command.server.teamUpdate:a.cache.detail&&(a.cache.detail.teamID=null===b||void 0===b?void 0:b.id);session.setTeam(b);break;case command.server.sprintUpdate:a.cache.detail&&(a.cache.detail.sprintID=null===b||
void 0===b?void 0:b.id);session.setSprint(b);break;case command.server.feedbackUpdate:feedback.onFeedbackUpdate(b);break;case command.server.feedbackRemove:feedback.onFeedbackRemoved(b);break;default:console.warn("unhandled command ["+c+"] for retro")}};a.onSubmitRetroSession=function(){var a=dom.req("#model-title-input").value,b=dom.req("#model-categories-input").value,d=dom.req("#model-team-select select").value,f=dom.req("#model-sprint-select select").value,g=permission.readPermissions();socket.send({svc:services.retro.key,
cmd:command.client.updateSession,param:{title:a,categories:b,teamID:d,sprintID:f,permissions:g}})}})(retro||(retro={}));var session;
(function(a){a.setDetail=function(a){var c,b=(null===(c=system.cache.session)||void 0===c?void 0:c.slug)||"invalid";system.cache.session=a;document.title=a.title;dom.setText("#model-title",a.title);dom.setText("#session-view-section .title",a.title);dom.setValue("#model-title-input",a.title);c=dom.els("#navbar .uk-navbar-item");0<c.length&&dom.setText(c[c.length-1],a.title);b!==a.slug&&(window.history.replaceState(null,"",document.location.href.replace(b,a.slug)),console.log("slugChanged!!!!!"));
modal.hide("session")};a.onSessionJoin=function(a){system.cache.apply(a);permission.setPerms();member.setMembers();comment.setCounts()};a.showWelcomeMessage=function(a){1===a&&setTimeout(function(){return modal.open("welcome")},300)};a.setTeam=function(a){modal.hide("session");var c=dom.req("#team-link-container"),b=dom.req("#session-view-section .team");dom.clear(c,b);dom.setDisplay("#team-warning-container",void 0!==a);a&&(c.appendChild(team.renderTeamLink(a)),b.appendChild(team.renderTeamLink(a,
!0)),dom.setText("#team-warning-name",a.title))};a.setSprint=function(a){modal.hide("session");var c=dom.req("#sprint-link-container"),b=dom.req("#session-view-section .sprint");dom.clear(c,b);dom.setDisplay("#sprint-warning-container",void 0!==a);a&&(c.appendChild(sprint.renderSprintLink(a)),b.appendChild(sprint.renderSprintLink(a,!0)),dom.setText("#sprint-warning-name",a.title))};a.onModalOpen=function(a){var c=dom.setValue("#model-title-input",dom.req("#model-title").innerText);setTimeout(function(){return c.focus()},
...
function c(b,c,d,g){d&&"complete"===d.status&&0<d.finalVote.length&&(c=d.finalVote);dom.setContent("#story-"+b+" .story-status",a.renderStatus(c));g&&a.showTotalIfNeeded()}a.viewStoryStatus=d;a.requestStoryStatus=function(b){var c=a.getActiveStory();c&&socket.send({svc:services.estimate.key,cmd:command.client.setStoryStatus,param:{storyID:c.id,status:b}})};a.setStoryStatus=c;a.onStoryStatusChange=function(a){var b=void 0;estimate.cache.stories.forEach(function(c){c.id===a.storyID&&(b=c,c.finalVote=
a.finalVote,c.status=a.status)});c(a.storyID,a.status,b,!0);a.storyID===estimate.cache.activeStory&&d(a.status)}})(story||(story={}));
...
(function(a){var d=function(a){this.members=[];this.key=a};a.Group=d;var c=function(){this.groups=[]};c.prototype.findOrInsert=function(a){var b=this.groups.find(function(b){return b.key===a});if(b)return b;b=new d(a);this.groups.push(b);return b};a.GroupSet=c;a.groupBy=function(a,d){var b=new c;a&&a.forEach(function(a){b.findOrInsert(d(a)).members.push(a)});return b};a.findGroup=function(a,c){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if(b=b.value,b.key===c)return b.members;
...
(function(a){function d(a,b){return UIkit.util.$$(a,b)}function c(a,b){b=d(a,b);switch(b.length){case 0:break;case 1:return b[0];default:console.warn("found ["+b.length+"] elements with selector ["+a+"], wanted zero or one")}}function b(a,b){(b=c(a,b))||console.warn("no element found for selector ["+a+"]");return b}function e(a,c){"string"===typeof a&&(a=b(a));a.innerHTML=c;return a}a.initDom=function(a,b){try{style.themeLinks(b),style.setTheme(a)}catch(h){console.warn("error setting style",h)}try{modal.wire()}catch(h){console.warn("error wiring modals",
h)}};a.els=d;a.opt=c;a.req=b;a.setHTML=e;a.setDisplay=function(a,c,d){d=void 0===d?"block":d;"string"===typeof a&&(a=b(a));a.style.display=c?d:"none";return a};a.setContent=function(c,d){"string"===typeof c&&(c=b(c));a.clear(c);c.appendChild(d);return c};a.setText=function(a,c){"string"===typeof a&&(a=b(a));a.innerText=c;return a};a.clear=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];b=$jscomp.makeIterator(b);for(c=b.next();!c.done;c=b.next())e(c.value,"")}})(dom||(dom={}));
...
function(d,c){"string"===typeof d&&(d=a.req(d));a.clear(d);c=$jscomp.makeIterator(c);for(var b=c.next();!b.done;b=c.next()){b=b.value;var e=document.createElement("option");e.value=b;a.setText(e,b);d.appendChild(e)}};a.setSelectOption=function(d,c){"string"===typeof d&&(d=a.req(d));for(var b=0;b<d.children.length;b++){var e=d.children.item(b);e.selected=e.value===c}};a.insertAtCaret=function(a,c){if(a.selectionStart||0===a.selectionStart){var b=a.selectionStart,d=a.selectionEnd;a.value=a.value.substring(0,
b)+c+a.value.substring(d,a.value.length);a.selectionStart=b+c.length;a.selectionEnd=b+c.length}else a.value+=c}})(dom||(dom={}));
...
(function(a){function d(a,b,c){b||(b=function(){});k.set(a,b);c&&m.set(a,c)}function c(a,b){l=b;(b=UIkit.modal("#modal-"+a))||console.warn("no modal available with key ["+a+"]");b.show();return!1}function b(a){if(a.target&&(a=a.target,0===a.id.indexOf("modal"))){a=a.id.substr(6);var b=k.get(a);b?b(l):console.warn("no modal open handler registered for ["+a+"]");l=void 0}}function e(a){a.target&&(a=a.target,a.classList.contains("uk-open")&&(a=a.id.substr(6),(a=m.get(a))&&a(l),l=void 0))}function f(a){if(a.target){var b=
a.target;a=b.dataset.key||"";b=b.dataset.t||"";var c=k.get(a);c?c(b):console.warn("no modal open handler registered for ["+a+"]")}}function g(a){if(a.target){var b=a.target;b.classList.contains("uk-open")&&(a=b.dataset.t||"",(b=m.get(b.dataset.key||""))&&b(a))}}function h(a){n&&a.preventDefault()}var k=new Map,m=new Map,l;a.register=d;a.wire=function(){UIkit.util.on(".drop","show",f);UIkit.util.on(".drop","beforehide",h);UIkit.util.on(".drop","hide",g);UIkit.util.on(".modal","show",b);UIkit.util.on(".modal",
"hide",e);d("welcome");d("session",session.onModalOpen);d("action",action.loadActions);d("comment",comment.load,comment.closeModal);d("self",member.viewSelf);d("invitation");d("member",member.viewActiveMember);d("add-story",story.viewAddStory);d("story",story.viewActiveStory);d("add-report",report.viewAddReport);d("report",report.viewReport);d("add-feedback",feedback.viewAddFeedback);d("feedback",feedback.viewFeedback)};a.open=c;a.openSoon=function(a){setTimeout(function(){return c(a)},0)};a.hide=
function(a){a=UIkit.modal("#modal-"+a);a.$el.classList.contains("uk-open")&&a.hide()};var n=!1;a.onEmojiPicked=function(){n=!0;setTimeout(function(){return n=!1},200)}})(modal||(modal={}));var notify;(function(a){a.notify=function(a,c){UIkit.notification(a,{status:c?"success":"danger",pos:"top-right"})}})(notify||(notify={}));var style;
(function(a){function d(a){c(a);var b=dom.els(".uk-card");switch(a){case "auto":var f="light";window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(f="dark");d(f);fetch("/profile/theme/"+f).then(function(a){return a.text()}).then(function(a){console.log("Set theme to ["+f+"]")});break;case "light":document.documentElement.classList.remove("uk-light");document.body.classList.remove("uk-light");document.documentElement.classList.add("uk-dark");document.body.classList.add("uk-dark");
...
!1)});else{var b={position:"bottom-end",theme:a,zIndex:1021};dom.els(".textarea-emoji").forEach(function(a){var c=dom.req(".picker-toggle",a);c.addEventListener("click",function(){var d=dom.req(".uk-textarea",a),e=new EmojiButton(b);e.on("emoji",function(a){modal.onEmojiPicked();dom.insertAtCaret(d,a)});e.togglePicker(c)},!1)})}}a.setTheme=d;a.themeLinks=function(a){dom.els(".theme").forEach(function(b){b.classList.add(a+"-fg")})}})(style||(style={}));var vote;
(function(a){function d(){var c=story.getActiveStory();if(c){var b=estimate.cache.activeVotes(),d=b.filter(function(a){return a.userID===system.cache.getProfile().userID}).pop();switch(c.status){case "pending":c=system.cache.getProfile().userID===c.userID;dom.setDisplay("#story-edit-section",c);dom.setDisplay("#story-view-section",!c);break;case "active":console.log("!!!!!!!!");console.log(b);dom.setContent("#story-vote-members",a.renderVoteMembers(member.getMembers(),b));dom.setContent("#story-vote-choices",
a.renderVoteChoices(estimate.cache.detail.choices,null===d||void 0===d?void 0:d.choice));break;case "complete":dom.setContent("#story-vote-results",a.renderVoteResults(member.getMembers(),b));dom.setContent("#story-vote-summary",a.renderVoteSummary(b));break;default:console.warn("invalid story status ["+c.status+"]")}}}a.setVotes=function(a){estimate.cache.votes=a;d()};a.onVoteUpdate=function(a){var b=estimate.cache.votes;b=b.filter(function(b){return b.userID!==a.userID||b.storyID!==a.storyID});
b.push(a);estimate.cache.votes=b;a.storyID===estimate.cache.activeStory&&d()};a.viewVotes=d;a.onSubmitVote=function(a){socket.send({svc:services.estimate.key,cmd:command.client.submitVote,param:{storyID:estimate.cache.activeStory,choice:a}})};a.getVoteResults=function(a){a=a.map(function(a){a=parseFloat(a.choice);return isNaN(a)?-1:a}).filter(function(a){return-1!==a}).sort();var b=a.length,c=Math.min.apply(Math,$jscomp.arrayFromIterable(a)),d=Math.max.apply(Math,$jscomp.arrayFromIterable(a)),g=a.reduce(function(a,
b){return a+b},0),h=a.reduce(function(a,b){var c=a.numMapping[b]=(a.numMapping[b]||0)+1;c>a.greatestFreq&&(a.greatestFreq=c,a.mode=b);return a},{mode:null,greatestFreq:-Infinity,numMapping:{}}).mode;return{count:b,min:c,max:d,sum:g,mean:0===b?0:g/b,median:0===b?0:a[Math.floor(a.length/2)],mode:0===b?0:h}}})(vote||(vote={}));
