...
$jscomp.arrayFromIterator=function(a){for(var d,c=[];!(d=a.next()).done;)c.push(d.value);return c};$jscomp.arrayFromIterable=function(a){return a instanceof Array?a:$jscomp.arrayFromIterator($jscomp.makeIterator(a))};$jscomp.findInternal=function(a,d,c){a instanceof String&&(a=String(a));for(var b=a.length,e=0;e<b;e++){var f=a[e];if(d.call(c,f,e,a))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
$jscomp.polyfill("WeakMap",function(a){function d(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),e=new a([[b,2],[c,3]]);if(2!=e.get(b)||3!=e.get(c))return!1;e.delete(b);e.set(c,4);return!e.has(b)&&4==e.get(c)}catch(m){return!1}}function c(){}function b(b){var a=typeof b;return"object"===a&&null!==b||"function"===a}function e(b){if(!$jscomp.owns(b,g)){var a=new c;$jscomp.defineProperty(b,g,{value:a})}}function f(b){var a=Object[b];a&&(Object[b]=function(b){if(b instanceof
...
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(d())return a;$jscomp.initSymbolIterator();var c=new WeakMap,b=function(a){this.data_={};this.head_=g();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};b.prototype.set=function(a,b){a=0===a?0:a;var c=e(this,a);c.list||(c.list=this.data_[c.id]=[]);c.entry?c.entry.value=b:(c.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,
value:b},c.list.push(c.entry),this.head_.previous.next=c.entry,this.head_.previous=c.entry,this.size++);return this};b.prototype.delete=function(a){a=e(this,a);return a.entry&&a.list?(a.list.splice(a.index,1),a.list.length||delete this.data_[a.id],a.entry.previous.next=a.entry.next,a.entry.next.previous=a.entry.previous,a.entry.head=null,this.size--,!0):!1};b.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=g();this.size=0};b.prototype.has=function(a){return!!e(this,a).entry};
b.prototype.get=function(a){return(a=e(this,a).entry)&&a.value};b.prototype.entries=function(){return f(this,function(a){return[a.key,a.value]})};b.prototype.keys=function(){return f(this,function(a){return a.key})};b.prototype.values=function(){return f(this,function(a){return a.value})};b.prototype.forEach=function(a,b){for(var c=this.entries(),e;!(e=c.next()).done;)e=e.value,a.call(b,e[1],e[0],this)};b.prototype[Symbol.iterator]=b.prototype.entries;var e=function(a,b){var e=b&&typeof b;"object"==
...
a.next=a.head=a},h=0;return b},"es6","es3");var rituals;(function(a){a.onError=function(a,c){console.error(a.key+": "+c);var b=c.lastIndexOf(":");-1<b&&(c=c.substr(b+1));UIkit.notification(a.key+" error: "+c,{status:"danger",pos:"top-right"})};a.init=function(a,c){window.onbeforeunload=function(){socket.setAppUnloading()};socket.socketConnect(services.fromKey(a),c)}})(rituals||(rituals={}));var action;
...
(function(a){a.renderActions=function(a){return 0===a.length?JSX("div",null,"No actions available"):JSX("table",{class:"uk-table uk-table-divider uk-text-left"},JSX("thead",null,JSX("tr",null,JSX("th",null,"User"),JSX("th",null,"Act"),JSX("th",null,"Content"),JSX("th",null,"Note"),JSX("th",null,"Created"))),JSX("tbody",null,a.map(function(a){var b=JSON.stringify(a.content,null,2);return JSX("tr",null,JSX("td",null,system.getMemberName(a.userID)),JSX("td",null,a.act),JSX("td",null,"null"===b?"":JSX("pre",
null,b)),JSX("td",null,a.note),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},date.toDateTimeString(new Date(a.created))))})))}})(action||(action={}));var auth;(function(a){a.allProviders=[{key:"github",title:"GitHub"},{key:"google",title:"Google"},{key:"slack",title:"Slack"},{key:"facebook",title:"Facebook"},{key:"amazon",title:"Amazon"},{key:"microsoft",title:"Microsoft"}]})(auth||(auth={}));var comment;
(function(a){function d(a,c,d,g){dom.req(".text",d).innerText=c.length.toString();"root"!==a&&dom.setDisplay(d,0!==c.length||!0===g)}var c;a.loadComments=function(b,e){b&&"modal"!==b||(b=c);b||console.warn("invalid comment type ["+b+"]");c=b;var d=system.cache.comments.filter(function(a){return a.targetType===b&&a.targetID==e});dom.setContent("#modal-comment-content",a.renderComments(d))};a.setComments=function(){var a=dom.els(".comment-count-container"),e=!1,f=dom.opt("#comment-count-modal");a.forEach(function(a){var b=
a.dataset.commentType,g=a.dataset.commentID;if(!b)throw"invalid comment type ["+b+"] with id ["+g+"]";var l=system.cache.comments.filter(function(a){return a.targetType===b&&a.targetID==g});d(b,l,a);c===b&&f&&(d(b,l,f),e=!0)});!e&&f&&d("modal",[],f,!0)};a.closeModal=function(){"story"===c?modal.openSoon("story"):"report"===c?modal.openSoon("report"):"feedback"===c&&modal.openSoon("feedback");c=void 0};a.setActive=function(a,e){c=a}})(comment||(comment={}));
(function(a){a.renderComments=function(a){return 0===a.length?JSX("div",null,"No comments available"):JSX("table",{class:"uk-table uk-table-divider uk-text-left"},JSX("thead",null,JSX("tr",null,JSX("th",null,"User"),JSX("th",null,"Content"),JSX("th",null,"Created"))),JSX("tbody",null,a.map(function(a){return JSX("tr",null,JSX("td",null,system.getMemberName(a.userID)),JSX("td",{dangerouslySetInnerHTML:{__html:a.html}}),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},date.toDateTimeString(new Date(a.created))))})))};
a.renderCount=function(a,c){var b=system.cache.getProfile();return JSX("div",{class:"comment-count-container uk-margin-small-left left hidden","data-commentType":a,"data-commentID":c},JSX("a",{class:b.linkColor+"-fg",title:"view comments"},JSX("div",{class:"comment-count"},JSX("span",{class:"uk-icon","data-uk-icon":"comments"}),JSX("span",{class:"text"}))))}})(comment||(comment={}));var contents;
(function(a){a.onContentDisplay=function(a,c,b,e){dom.setDisplay("#modal-"+a+" .content-edit",c);dom.setDisplay("#modal-"+a+" .buttons-edit",c);var d=dom.setDisplay("#modal-"+a+" .content-view",!c);dom.setHTML(d,c?"":e);dom.setDisplay("#modal-"+a+" .buttons-view",!c);a=dom.req("#"+a+"-edit-content");dom.setValue(a,c?b:"");c&&dom.wireTextarea(a)}})(contents||(contents={}));
...
a.slug},a.title)),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},system.getMemberName(a.owner)),JSX("td",{class:"uk-table-shrink uk-text-nowrap"},date.toDateTimeString(new Date(a.created))))})))}})(contents||(contents={}));var estimate;
(function(a){function d(b){a.cache.detail=b;dom.setValue("#model-choices-input",b.choices.join(", "));story.viewActiveStory();session.setDetail(b)}function c(b){var c=e(b.id);c.push(b);c.sort(function(a){return a.idx});b.id===a.cache.activeStory&&dom.setText("#story-title",b.title);story.setStories(c)}function b(b){var c=e(b);story.setStories(c);b===a.cache.activeStory&&modal.hide("story");UIkit.notification("story has been deleted",{status:"success",pos:"top-right"})}function e(b){return a.cache.stories.filter(function(a){return a.id!==
...
break;default:console.warn("unhandled command ["+e+"] for estimate")}};a.onSubmitEstimateSession=function(){var a=dom.req("#model-title-input").value,b=dom.req("#model-choices-input").value,c=dom.req("#model-team-select select").value,e=dom.req("#model-sprint-select select").value,d=permission.readPermissions();socket.send({svc:services.estimate.key,cmd:command.client.updateSession,param:{title:a,choices:b,teamID:c,sprintID:e,permissions:d}})};a.onStoryUpdate=c;a.onStoryRemove=b})(estimate||(estimate=
{}));var feedback;
...
comment.setComments();modal.hide("add-feedback")};a.onSubmitFeedback=function(){var a=dom.req("#feedback-category").value,b=dom.req("#feedback-content").value;socket.send({svc:services.retro.key,cmd:command.client.addFeedback,param:{category:a,content:b}});return!1};a.onEditFeedback=function(){var a=retro.cache.activeFeedback,b=dom.req("#feedback-edit-category").value,c=dom.req("#feedback-edit-content").value;socket.send({svc:services.retro.key,cmd:command.client.updateFeedback,param:{id:a,category:b,
content:c}});return!1};a.onRemoveFeedback=function(){var a=retro.cache.activeFeedback;a&&UIkit.modal.confirm("Delete this feedback?").then(function(){socket.send({svc:services.retro.key,cmd:command.client.removeFeedback,param:a});modal.hide("feedback")});return!1};a.getActiveFeedback=d;a.viewActiveFeedback=function(a){var b=system.cache.getProfile();a&&(retro.cache.activeFeedback=a);(a=d())?(b=a.userID===b.userID,dom.setText("#feedback-title",a.category+" / "+system.getMemberName(a.userID)),dom.setSelectOption("#feedback-edit-category",
b?a.category:void 0),contents.onContentDisplay("feedback",b,a.content,a.html),comment.setActive("feedback",a.id),comment.setComments()):console.warn("no active feedback")};a.onFeedbackUpdate=function(a){var e=c(a.id);e.push(a);b(e,a.id)};a.onFeedbackRemoved=function(a){var e=c(a);b(e,a);UIkit.notification("feedback has been deleted",{status:"success",pos:"top-right"})};a.getFeedbackCategories=function(a,b){var c=b.map(function(b){var c=a.filter(function(a){return a.category===b}).sort(function(a,
b){return a.created>b.created?-1:1});return{category:b,feedback:c}}),e=a.filter(function(a){return!b.find(function(b){return b===a.category})});0<e.length&&c.push({category:"unknown",feedback:e});return c};a.viewAddFeedback=function(a){dom.setSelectOption("#feedback-category",a);var b=dom.setValue("#feedback-content","");dom.wireTextarea(b);setTimeout(function(){return b.focus()},250)};a.viewFeedback=function(a){feedback.viewActiveFeedback(a);var b=dom.req("#feedback-edit-content");setTimeout(function(){dom.wireTextarea(b);
b.focus()},250)}})(feedback||(feedback={}));
...
a.id+"');"},JSX("div",{class:"feedback-comments right"},comment.renderCount("feedback",a.id)),JSX("div",{class:"left"},JSX("a",{class:b.linkColor+"-fg section-link"},system.getMemberName(a.userID))),JSX("div",{class:"clear"}),JSX("div",{class:"feedback-content"},"loading..."));0<a.html.length&&(dom.setHTML(dom.req(".feedback-content",b),a.html).style.display="block");return JSX("div",null,b)})))}))}})(feedback||(feedback={}));var member;
(function(a){function d(a){return a.userID===system.cache.getProfile().userID}function c(){var c=system.cache.members.filter(d).shift();c&&(dom.setText("#member-self .member-name",c.name),dom.setValue("#self-name-input",c.name),dom.setText("#member-self .member-role",c.role));c=system.cache.members.filter(function(a){return!d(a)});dom.setContent("#member-detail",a.renderMembers(c));b()}function b(){for(var a={},b=$jscomp.makeIterator(system.cache.members),c=b.next();!c.done;a={$jscomp$loop$prop$member$6$10:a.$jscomp$loop$prop$member$6$10},
c=b.next())a.$jscomp$loop$prop$member$6$10=c.value,(c=dom.opt("#member-"+a.$jscomp$loop$prop$member$6$10.userID+" .online-indicator"))&&(system.cache.online.find(function(a){return function(b){return b===a.$jscomp$loop$prop$member$6$10.userID}}(a))?c.classList.remove("offline"):c.classList.add("offline"))}function e(){if(f){var a=system.cache.members.filter(function(a){return a.userID===f}).shift();a&&console.warn("cannot load active member ["+f+"]");return a}console.warn("no active member")}a.setMembers=
c;a.onMemberUpdate=function(a){var b;d(a)&&modal.hide("self");var e=system.cache.members,f=e.filter(function(b){return b.userID===a.userID}).shift();f=(null===f||void 0===f?void 0:f.name)!==a.name;e=e.filter(function(b){return b.userID!==a.userID});e.length===system.cache.members.length&&UIkit.notification(a.name+" has joined",{status:"success",pos:"top-right"});"::delete"===a.name?a.userID===system.cache.getProfile().userID?(modal.hide("self"),UIkit.notification("you have left this "+(null===(b=
system.cache.currentService)||void 0===b?void 0:b.key),{status:"success",pos:"top-right"}),document.location.href="/"):modal.hide("member"):e.push(a);e.sort(function(a,b){return a.name>b.name?1:-1});system.cache.members=e;c();if(f)switch(system.cache.currentService){case services.estimate:estimate.cache.activeStory&&vote.viewVotes();break;case services.standup:dom.setContent("#report-detail",report.renderReports(standup.cache.reports));standup.cache.activeReport&&report.viewActiveReport();break;case services.retro:dom.setContent("#feedback-detail",
feedback.renderFeedbackArray(retro.cache.feedback)),retro.cache.activeFeedback&&feedback.viewActiveFeedback()}};a.onOnlineUpdate=function(a){a.connected?system.cache.online.find(function(b){return b===a.userID})||system.cache.online.push(a.userID):system.cache.online=system.cache.online.filter(function(b){return b!==a.userID});b()};a.onSubmitSelf=function(){var a=dom.req("#self-name-input").value,b=dom.req("#self-name-choice-global").checked?"global":"local";socket.send({svc:services.system.key,cmd:command.client.updateProfile,
param:{name:a,choice:b}})};var f;a.viewActiveMember=function(a){a&&(f=a);if(a=e())dom.setText("#member-modal-name",a.name),dom.setText("#member-modal-role",a.role)};a.removeMember=function(a){(a=void 0===a?f:a)||console.warn("cannot load active member ["+f+"]");"self"===a&&(a=system.cache.getProfile().userID);var b=system.cache.currentService;confirm("Are you sure you wish to leave this "+b.key+"?")&&socket.send({svc:b.key,cmd:command.client.removeMember,param:a})}})(member||(member={}));
(function(a){a.renderMembers=function(a){return 0===a.length?JSX("div",null,JSX("button",{class:"uk-button uk-button-default",onclick:"modal.open('invitation');",type:"button"},"Invite Members")):JSX("ul",{class:"uk-list uk-list-divider"},a.map(function(a){var b={id:"member-"+a.userID},c=system.cache.getProfile();a=JSX("div",{class:"section",onclick:"modal.open('member', '"+a.userID+"');"},JSX("div",{title:"user is offline",class:"right uk-article-meta online-indicator"},"offline"),JSX("div",{class:c.linkColor+
"-fg section-link"},a.name));return JSX("li",b,a)}))};a.viewSelf=function(){var a=dom.setValue("#self-name-input",dom.req("#member-self .member-name").innerText);setTimeout(function(){return a.focus()},250)}})(member||(member={}));var command;
(function(a){a.client={error:"error",ping:"ping",connect:"connect",updateSession:"update-session",getActions:"get-actions",getTeams:"get-teams",getSprints:"get-sprints",updateProfile:"update-profile",removeMember:"remove-member",addStory:"add-story",updateStory:"update-story",removeStory:"remove-story",setStoryStatus:"set-story-status",submitVote:"submit-vote",addReport:"add-report",updateReport:"update-report",removeReport:"remove-report",addFeedback:"add-feedback",updateFeedback:"update-feedback",
removeFeedback:"remove-feedback"};a.server={error:"error",pong:"pong",sessionJoined:"session-joined",sessionUpdate:"session-update",permissionsUpdate:"permissions-update",teamUpdate:"team-update",sprintUpdate:"sprint-update",contentUpdate:"content-update",actions:"actions",teams:"teams",sprints:"sprints",memberUpdate:"member-update",onlineUpdate:"online-update",storyUpdate:"story-update",storyRemove:"story-remove",storyStatusChange:"story-status-change",voteUpdate:"vote-update",reportUpdate:"report-update",
reportRemove:"report-remove",feedbackUpdate:"feedback-update",feedbackRemove:"feedback-remove"}})(command||(command={}));var services;
...
(function(a){function d(a){var b=dom.opt("#model-"+a+"-select select");if(b){var c=collection.findGroup(system.cache.permissions,a),e=dom.opt("#perm-"+a+"-section");e&&(dom.req("#perm-"+a+"-checkbox").checked=0<c.length,dom.setDisplay(e,""!==b.value));collection.findGroup(system.cache.permissions,a)}}function c(a,b){dom.els(".perm-"+a+"-email").forEach(function(a){a.disabled=!b;b||(a.checked=!1)})}function b(b){var c=collection.findGroup(system.cache.permissions,b.key),e=system.cache.auths.filter(function(a){return a.provider===
b.key});if(dom.opt("#perm-"+b.key+"-section")){dom.req("#perm-"+b.key+"-checkbox").checked=0<c.length;var d=dom.req("#perm-"+b.key+"-email-container"),k=collection.flatten(c.map(function(a){return a.v.split(",").filter(function(a){return 0<a.length})})).map(function(a){return{matched:!0,domain:a}});c=e.filter(function(a){return 0===k.filter(function(b){return a.email.endsWith(b.domain)}).length}).map(function(a){a=a.email;var b=a.lastIndexOf("@");a=-1===b?a:a.substr(b);return{matched:!1,domain:a}});
k.push.apply(k,$jscomp.arrayFromIterable(c));k.sort();dom.setDisplay(d,0<k.length);dom.setContent(d,0===k.length?document.createElement("span"):a.renderEmails(b.key,k))}}a.setPerms=function(){var a=system.cache.permissions;dom.setDisplay("#public-link-container",null===a||0===a.length);dom.setDisplay("#private-link-container",null!==a&&0<a.length);["team","sprint"].forEach(d);null!==system.cache.auths&&auth.allProviders.forEach(b)};a.setModelPerms=d;a.onChanged=function(a,b,d){switch(a){case "email":(a=
dom.opt("#perm-"+b+"-checkbox"))&&d&&!a.checked&&(a.checked=!0);break;case "provider":return c(b,d)}}})(permission||(permission={}));
(function(a){function d(a){var b=dom.opt("#perm-"+a+"-checkbox");if(!b||!b.checked)return[];b=dom.els(".perm-"+a+"-email").filter(function(a){return a.checked}).map(function(a){return a.value}).join(",");return[{k:a,v:b,access:"member"}]}a.renderEmails=function(a,b){var c="uk-checkbox uk-margin-small-right perm-"+a+"-email",d="permission.onChanged('email', '"+a+"', this.checked)";return JSX("ul",null,b.map(function(a){return JSX("li",null,JSX("label",null,a.matched?JSX("input",{class:c,type:"checkbox",
value:a.domain,checked:"checked",onchange:d}):JSX("input",{class:c,type:"checkbox",value:a.domain,onchange:d}),"Using email address ",a.domain))}))};a.readPermissions=function(){var a=[];a.push.apply(a,$jscomp.arrayFromIterable(d("team")));a.push.apply(a,$jscomp.arrayFromIterable(d("sprint")));a.push.apply(a,$jscomp.arrayFromIterable(d("github")));a.push.apply(a,$jscomp.arrayFromIterable(d("google")));a.push.apply(a,$jscomp.arrayFromIterable(d("slack")));a.push.apply(a,$jscomp.arrayFromIterable(d("facebook")));
a.push.apply(a,$jscomp.arrayFromIterable(d("amazon")));a.push.apply(a,$jscomp.arrayFromIterable(d("microsoft")));return a};a.applyPermissions=function(a){system.cache.permissions=collection.groupBy(a,function(a){return a.k}).groups}})(permission||(permission={}));var report;
...
dom.req("#report-edit-date").value,b=dom.req("#report-edit-content").value;socket.send({svc:services.standup.key,cmd:command.client.updateReport,param:{id:standup.cache.activeReport,d:a,content:b}});return!1};a.onRemoveReport=function(){var a=standup.cache.activeReport;a&&UIkit.modal.confirm("Delete this report?").then(function(){socket.send({svc:services.standup.key,cmd:command.client.removeReport,param:a});modal.hide("report")});return!1};a.viewActiveReport=function(a){var b=system.cache.getProfile();
a&&(standup.cache.activeReport=a);(a=d())?(dom.setText("#report-title",date.toDateString(date.dateFromYMD(a.d))+" - "+system.getMemberName(a.userID)),b=a.userID===b.userID,dom.setValue(dom.req("#report-edit-date"),b?a.d:""),contents.onContentDisplay("report",b,a.content,a.html),comment.setActive("report",a.id),comment.setComments()):console.warn("no active report")};a.setReports=function(c){standup.cache.reports=c;dom.setContent("#report-detail",a.renderReports(c));comment.setComments();modal.hide("add-report")};
a.getReportDates=function(a){return a.map(function(a){return a.d}).filter(function(a,c,d){return d.indexOf(a)===c}).sort().reverse().map(function(b){var c=a.filter(function(a){return a.d===b}).sort(function(a,b){return a.created>b.created?-1:1});return{d:b,reports:c}})};a.viewAddReport=function(){dom.setValue("#report-date",date.dateToYMD(new Date));var a=dom.setValue("#report-content","");dom.wireTextarea(a);setTimeout(function(){return a.focus()},250)};a.viewReport=function(a){report.viewActiveReport(a);
...
b=JSX("div",{id:"report-"+a.id,class:"report-detail section",onclick:"modal.open('report', '"+a.id+"');"},JSX("div",{class:"report-comments right"},comment.renderCount("report",a.id)),JSX("div",{class:"left"},JSX("a",{class:b.linkColor+"-fg section-link"},system.getMemberName(a.userID))),JSX("div",{class:"clear"}),JSX("div",{class:"report-content"},"loading..."));0<a.html.length&&(dom.setHTML(dom.req(".report-content",b),a.html).style.display="block");return JSX("li",null,b)})))}))}})(report||(report=
{}));var retro;
(function(a){function d(c){a.cache.detail=c;dom.setValue("#model-categories-input",c.categories.join(", "));dom.setOptions("#feedback-category",c.categories);dom.setOptions("#feedback-edit-category",c.categories);feedback.setFeedback(a.cache.feedback);session.setDetail(c)}a.cache=new function(){this.feedback=[]};a.onRetroMessage=function(c,b){switch(c){case command.server.error:rituals.onError(services.retro,b);break;case command.server.sessionJoined:session.onSessionJoin(b);d(b.session);feedback.setFeedback(b.feedback);
session.showWelcomeMessage(b.members.length);break;case command.server.sessionUpdate:d(b);break;case command.server.permissionsUpdate:system.setPermissions(b);break;case command.server.teamUpdate:a.cache.detail&&(a.cache.detail.teamID=null===b||void 0===b?void 0:b.id);session.setTeam(b);break;case command.server.sprintUpdate:a.cache.detail&&(a.cache.detail.sprintID=null===b||void 0===b?void 0:b.id);session.setSprint(b);break;case command.server.feedbackUpdate:feedback.onFeedbackUpdate(b);break;case command.server.feedbackRemove:feedback.onFeedbackRemoved(b);
break;default:console.warn("unhandled command ["+c+"] for retro")}};a.onSubmitRetroSession=function(){var a=dom.req("#model-title-input").value,b=dom.req("#model-categories-input").value,e=dom.req("#model-team-select select").value,d=dom.req("#model-sprint-select select").value,g=permission.readPermissions();socket.send({svc:services.retro.key,cmd:command.client.updateSession,param:{title:a,categories:b,teamID:e,sprintID:d,permissions:g}})}})(retro||(retro={}));var session;
(function(a){a.setDetail=function(a){system.cache.session=a;document.title=a.title;dom.setText("#model-title",a.title);dom.setValue("#model-title-input",a.title);var c=dom.els("#navbar .uk-navbar-item");0<c.length&&(c[c.length-1].innerText=a.title);modal.hide("session")};a.onSessionJoin=function(a){system.cache.apply(a);permission.setPerms();member.setMembers();comment.setComments()};a.showWelcomeMessage=function(a){1===a&&setTimeout(function(){return modal.open("welcome")},300)};a.setSprint=function(a){modal.hide("session");
var c=dom.req("#sprint-link-container");c.innerHTML="";a&&(c.appendChild(sprint.renderSprintLink(a)),dom.req("#sprint-warning-name").innerText=a.title)};a.setTeam=function(a){modal.hide("session");var c=dom.req("#team-link-container");c.innerHTML="";a&&c.appendChild(team.renderTeamLink(a))};a.onModalOpen=function(a){var c=dom.setValue("#model-title-input",dom.req("#model-title").innerText);setTimeout(function(){return c.focus()},250);team.refreshTeams();sprint.refreshSprints()}})(session||(session=
{}));var socket;
...
c,d,g){d&&"complete"===d.status&&0<d.finalVote.length&&(c=d.finalVote);dom.setContent("#story-"+b+" .story-status",a.renderStatus(c));g&&a.showTotalIfNeeded()}a.viewStoryStatus=d;a.requestStoryStatus=function(b){var c=a.getActiveStory();c&&socket.send({svc:services.estimate.key,cmd:command.client.setStoryStatus,param:{storyID:c.id,status:b}})};a.setStoryStatus=c;a.onStoryStatusChange=function(a){var b;estimate.cache.stories.forEach(function(c){c.id===a.storyID&&(b=c,c.finalVote=a.finalVote,c.status=
a.status)});c(a.storyID,a.status,b,!0);a.storyID===estimate.cache.activeStory&&d(a.status)}})(story||(story={}));
...
(estimate.cache.activeStory=b);if(b=d())dom.setText("#story-title",b.title),a.viewStoryStatus(b.status),comment.setActive("story",b.id),comment.setComments()};a.showTotalIfNeeded=c})(story||(story={}));
...
(function(a){var d=function(){this.currentID="";this.connectTime=0;this.permissions=[];this.auths=[];this.members=[];this.online=[];this.comments=[]};d.prototype.getProfile=function(){if(!this.profile)throw"no active profile";return this.profile};d.prototype.apply=function(c){a.cache.session=c.session;a.cache.profile=c.profile;a.cache.auths=c.auths;permission.applyPermissions(c.permissions);a.cache.members=c.members;a.cache.online=c.online;a.cache.comments=c.comments;c.team&&session.setTeam(c.team);
c.sprint&&session.setSprint(c.sprint)};a.getMemberName=function(c){var b=a.cache.members.filter(function(a){return a.userID===c}).shift();return b?b.name:"{former member}"};a.cache=new d;a.setPermissions=function(a){permission.applyPermissions(a);permission.setPerms()};a.setAuths=function(c){a.cache.auths=c;permission.setPerms()};a.onSystemMessage=function(a,b){switch(a){case command.server.error:rituals.onError(services.system,b);break;case command.server.actions:action.viewActions(b);break;case command.server.teams:team.viewTeams(b);
break;case command.server.sprints:sprint.viewSprints(b);break;case command.server.memberUpdate:member.onMemberUpdate(b);break;case command.server.onlineUpdate:member.onOnlineUpdate(b);break;default:console.warn("unhandled system message for command ["+a+"]")}}})(system||(system={}));var team;
...
function(){var a=dom.req("#model-title-input").value,c=permission.readPermissions();socket.send({svc:services.team.key,cmd:command.client.updateSession,param:{title:a,permissions:c}})};a.refreshTeams=function(){dom.opt("#model-team-select")&&socket.send({svc:services.system.key,cmd:command.client.getTeams,param:null})};a.viewTeams=function(d){var c,b=dom.opt("#model-team-container");b&&(dom.setDisplay(b,0<d.length),dom.setContent("#model-team-select",a.renderTeamSelect(d,null===(c=system.cache.session)||
void 0===c?void 0:c.teamID)),permission.setModelPerms("team"))}})(team||(team={}));
(function(a){a.renderTeamLink=function(a){var c=system.cache.getProfile();return JSX("span",null," in ",JSX("a",{class:c.linkColor+"-fg",href:"/team/"+a.slug},a.title))};a.renderTeamSelect=function(a,c){return JSX("select",{class:"uk-select",onchange:"permission.setModelPerms('team')"},JSX("option",{value:""},"- no team -"),a.map(function(a){return a.id===c?JSX("option",{selected:"selected",value:a.id},a.title):JSX("option",{value:a.id},a.title)}))}})(team||(team={}));var profile;
...
a.classList.add("active")}})(profile||(profile={}));var collection;
(function(a){var d=function(a){this.members=[];this.key=a};a.Group=d;var c=function(){this.groups=[]};c.prototype.findOrInsert=function(a){var b=this.groups.find(function(b){return b.key===a});if(b)return b;b=new d(a);this.groups.push(b);return b};a.GroupSet=c;a.groupBy=function(a,e){var b=new c;a&&a.forEach(function(a){b.findOrInsert(e(a)).members.push(a)});return b};a.findGroup=function(a,c){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())if(b=b.value,b.key===c)return b.members;
...
a.toDateString=d;a.toTimeString=c;a.toDateTimeString=function(a){return d(a)+" "+c(a)};var b=6E4*(new Date).getTimezoneOffset();a.utcDate=function(a){return new Date(Date.parse(a)+b)}})(date||(date={}));var dom;
(function(a){function d(a,b){return UIkit.util.$$(a,b)}function c(a,b){return d(a,b).shift()}function b(a,b){(b=c(a,b))||console.warn("no element found for selector ["+a+"]");return b}a.initDom=function(a,b){try{style.themeLinks(b),style.setTheme(a)}catch(g){console.warn("error setting style",g)}document.body.style.visibility="visible";try{modal.wire()}catch(g){console.warn("error wiring modals",g)}};a.els=d;a.opt=c;a.req=b;a.setHTML=function(a,c){"string"===typeof a&&(a=b(a));a.innerHTML=c;return a};
a.setDisplay=function(a,c,d){d=void 0===d?"block":d;"string"===typeof a&&(a=b(a));a.style.display=c?d:"none";return a};a.setContent=function(a,c){"string"===typeof a&&(a=b(a));a.innerHTML="";a.appendChild(c);return a};a.setText=function(a,c){"string"===typeof a&&(a=b(a));a.innerText=c;return a}})(dom||(dom={}));
...
function(d,c){"string"===typeof d&&(d=a.req(d));d.innerHTML="";c=$jscomp.makeIterator(c);for(var b=c.next();!b.done;b=c.next()){b=b.value;var e=document.createElement("option");e.value=b;e.innerText=b;d.appendChild(e)}};a.setSelectOption=function(d,c){"string"===typeof d&&(d=a.req(d));for(var b=0;b<d.children.length;b++){var e=d.children.item(b);e.selected=e.value===c}}})(dom||(dom={}));
function JSX(a,d){var c=document.createElement(a),b;for(b in d)if(b&&d.hasOwnProperty(b)){var e=d[b];"dangerouslySetInnerHTML"===b?c.innerHTML=e.__html:!0===e?c.setAttribute(b,b):!1!==e&&null!==e&&void 0!==e&&c.setAttribute(b,e.toString())}for(b=2;b<arguments.length;b++)e=arguments[b],Array.isArray(e)?e.forEach(function(a){c.appendChild(a)}):(e.nodeType||(e=document.createTextNode(e.toString())),c.appendChild(e));return c}var modal;
(function(a){function d(a,b,c){b||(b=function(){});f.set(a,b);c&&g.set(a,c)}function c(a,b){h=b;(b=UIkit.modal("#modal-"+a))||console.warn("no modal available with key ["+a+"]");b.show();return!1}function b(a){if(a.target){a=a.target.id.substr(6);var b=f.get(a);b?b(h):console.warn("no modal open handler registered for ["+a+"]");h=void 0}}function e(a){a.target&&(a=a.target,a.classList.contains("uk-open")&&(a=a.id.substr(6),(a=g.get(a))&&a(h),h=void 0))}var f=new Map,g=new Map,h;a.register=d;a.wire=
function(){UIkit.util.on(".modal","show",b);UIkit.util.on(".modal","hide",e);d("welcome");d("session",session.onModalOpen);d("action",action.loadActions);d("comment",comment.loadComments,comment.closeModal);d("self",member.viewSelf);d("invitation");d("member",member.viewActiveMember);d("add-story",story.viewAddStory);d("story",story.viewActiveStory);d("add-report",report.viewAddReport);d("report",report.viewReport);d("add-feedback",feedback.viewAddFeedback);d("feedback",feedback.viewFeedback)};a.open=
c;a.openSoon=function(a){setTimeout(function(){return c(a)},0)};a.hide=function(a){a=UIkit.modal("#modal-"+a);a.$el.classList.contains("uk-open")&&a.hide()}})(modal||(modal={}));var style;
(function(a){function d(a){c(a);var b=dom.els(".uk-card");switch(a){case "default":window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?d("dark"):d("light");break;case "light":document.documentElement.classList.remove("uk-light");document.body.classList.remove("uk-light");document.documentElement.classList.add("uk-dark");document.body.classList.add("uk-dark");b.forEach(function(a){a.classList.add("uk-card-default");a.classList.remove("uk-card-secondary")});break;case "dark":document.documentElement.classList.add("uk-light");
...
dom.req(".picker-toggle",a);c.addEventListener("click",function(){var d=dom.req(".uk-textarea",a),e=new EmojiButton(b);e.on("emoji",function(a){d.value+=a});e.togglePicker(c)},!1)})}}a.setTheme=d;a.themeLinks=function(a){dom.els(".theme").forEach(function(b){b.classList.add(a+"-fg")})}})(style||(style={}));var vote;
(function(a){function d(){var c=story.getActiveStory();if(c){var b=estimate.cache.activeVotes(),d=b.filter(function(a){return a.userID===system.cache.getProfile().userID}).pop();switch(c.status){case "pending":c=system.cache.getProfile().userID===c.userID;dom.setDisplay("#story-edit-section",c);dom.setDisplay("#story-view-section",!c);break;case "active":dom.setContent("#story-vote-members",a.renderVoteMembers(system.cache.members,b));dom.setContent("#story-vote-choices",a.renderVoteChoices(estimate.cache.detail.choices,
null===d||void 0===d?void 0:d.choice));break;case "complete":dom.setContent("#story-vote-results",a.renderVoteResults(system.cache.members,b));dom.setContent("#story-vote-summary",a.renderVoteSummary(b));break;default:console.warn("invalid story status ["+c.status+"]")}}}a.setVotes=function(a){estimate.cache.votes=a;d()};a.onVoteUpdate=function(a){var b=estimate.cache.votes;b=b.filter(function(a){return a.userID!==a.userID||a.storyID!==a.storyID});b.push(a);estimate.cache.votes=b;a.storyID===estimate.cache.activeStory&&
