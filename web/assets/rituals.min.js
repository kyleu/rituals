...
$jscomp.polyfill("WeakMap",function(a){function d(){if(!a||!Object.seal)return!1;try{var c=Object.seal({}),b=Object.seal({}),e=new a([[c,2],[b,3]]);if(2!=e.get(c)||3!=e.get(b))return!1;e.delete(c);e.set(b,4);return!e.has(c)&&4==e.get(b)}catch(m){return!1}}function c(){}function b(a){var c=typeof a;return"object"===c&&null!==a||"function"===c}function e(a){if(!$jscomp.owns(a,g)){var b=new c;$jscomp.defineProperty(a,g,{value:b})}}function f(a){var b=Object[a];b&&(Object[a]=function(a){if(a instanceof
c)return a;e(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(d())return a;var g="$jscomp_hidden_"+Math.random();f("freeze");f("preventExtensions");f("seal");var h=0,k=function(a){this.id_=(h+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};k.prototype.set=function(a,c){if(!b(a))throw Error("Invalid WeakMap key");e(a);if(!$jscomp.owns(a,g))throw Error("WeakMap key fail: "+
...
(function(a){function d(a){return a.userID===system.cache.getProfile().userID}function c(){var c=g.filter(d).shift();c&&(dom.setText("#member-self .member-name",c.name),dom.setValue("#self-name-input",c.name),dom.setText("#member-self .member-role",c.role));c=g.filter(function(a){return!d(a)});dom.setContent("#member-detail",a.renderMembers(c));b()}function b(){for(var a={},b=$jscomp.makeIterator(g),c=b.next();!c.done;a={$jscomp$loop$prop$member$6$10:a.$jscomp$loop$prop$member$6$10},c=b.next())a.$jscomp$loop$prop$member$6$10=
c.value,(c=dom.opt("#member-"+a.$jscomp$loop$prop$member$6$10.userID+" .online-indicator"))&&(f.find(function(a){return function(b){return b===a.$jscomp$loop$prop$member$6$10.userID}}(a))?c.classList.remove("offline"):c.classList.add("offline"))}function e(){if(h){var a=g.filter(function(a){return a.userID===h}).shift();a&&console.warn("cannot load active member ["+h+"]");return a}console.warn("no active member")}var f=[],g=[];a.getMembers=function(){return g};a.getMember=function(a){return g.filter(function(b){return b.userID===
a}).shift()};a.setMembers=c;a.onMemberUpdate=function(a){var b;d(a)&&modal.hide("self");var e=g,f=e.filter(function(b){return b.userID===a.userID}).shift();f=(null===f||void 0===f?void 0:f.name)!==a.name;e=e.filter(function(b){return b.userID!==a.userID});e.length===g.length&&notify.notify(a.name+" has joined",!0);"::delete"===a.name?a.userID===system.cache.getProfile().userID?(modal.hide("self"),notify.notify("you have left this "+(null===(b=system.cache.currentService)||void 0===b?void 0:b.key),
!0),document.location.href="/"):modal.hide("member"):e.push(a);e.sort(function(a,b){return a.name>b.name?1:-1});g=e;c();if(f)switch(system.cache.currentService){case services.estimate:estimate.cache.activeStory&&vote.viewVotes();break;case services.standup:dom.setContent("#report-detail",report.renderReports(standup.cache.reports));standup.cache.activeReport&&report.viewActiveReport();break;case services.retro:dom.setContent("#feedback-detail",feedback.renderFeedbackArray(retro.cache.feedback)),retro.cache.activeFeedback&&
feedback.viewActiveFeedback()}};a.onOnlineUpdate=function(a){a.connected?f.find(function(b){return b===a.userID})||f.push(a.userID):f=f.filter(function(b){return b!==a.userID});b()};a.onSubmitSelf=function(){var a=dom.req("#self-name-input").value,b=dom.req("#self-name-choice-global").checked?"global":"local";socket.send({svc:services.system.key,cmd:command.client.updateProfile,param:{name:a,choice:b}})};var h;a.viewActiveMember=function(a){a&&(h=a);if(a=e())dom.setText("#member-modal-name",a.name),
dom.setText("#member-modal-role",a.role)};a.removeMember=function(a){(a=void 0===a?h:a)||console.warn("cannot load active member ["+h+"]");"self"===a&&(a=system.cache.getProfile().userID);var b=system.cache.currentService;confirm("Are you sure you wish to leave this "+b.key+"?")&&socket.send({svc:b.key,cmd:command.client.removeMember,param:a})};a.applyMembers=function(a){g=a};a.applyOnline=function(a){f=a}})(member||(member={}));
(function(a){function d(a){return a?a.picture&&0<a.picture.length?JSX("div",null,JSX("div",null,a.picture?a.picture:""),JSX("div",null,a.name)):JSX("span",null,a.name):JSX("span",null,"{former member}")}a.renderMembers=function(a){return 0===a.length?JSX("div",null,JSX("button",{class:"uk-button uk-button-default",onclick:"modal.open('invitation');",type:"button"},"Invite Members")):JSX("ul",{class:"uk-list uk-list-divider"},a.map(function(a){var b={id:"member-"+a.userID},c=system.cache.getProfile();
a=JSX("div",{class:"section",onclick:"modal.open('member', '"+a.userID+"');"},JSX("div",{title:"user is offline",class:"right uk-article-meta online-indicator"},"offline"),JSX("div",{class:c.linkColor+"-fg section-link"},d(a)));return JSX("li",b,a)}))};a.renderTitle=d;a.viewSelf=function(){var a=dom.setValue("#self-name-input",dom.req("#member-self .member-name").innerText);setTimeout(function(){return a.focus()},250)}})(member||(member={}));var command;
...
(function(a){a.setDetail=function(a){system.cache.session=a;document.title=a.title;dom.setText("#model-title",a.title);dom.setValue("#model-title-input",a.title);var c=dom.els("#navbar .uk-navbar-item");0<c.length&&(c[c.length-1].innerText=a.title);modal.hide("session")};a.onSessionJoin=function(a){system.cache.apply(a);permission.setPerms();member.setMembers();comment.setCounts()};a.showWelcomeMessage=function(a){1===a&&setTimeout(function(){return modal.open("welcome")},300)};a.setSprint=function(a){modal.hide("session");
...
function c(b,c,d,g){d&&"complete"===d.status&&0<d.finalVote.length&&(c=d.finalVote);dom.setContent("#story-"+b+" .story-status",a.renderStatus(c));g&&a.showTotalIfNeeded()}a.viewStoryStatus=d;a.requestStoryStatus=function(b){var c=a.getActiveStory();c&&socket.send({svc:services.estimate.key,cmd:command.client.setStoryStatus,param:{storyID:c.id,status:b}})};a.setStoryStatus=c;a.onStoryStatusChange=function(a){var b;estimate.cache.stories.forEach(function(c){c.id===a.storyID&&(b=c,c.finalVote=a.finalVote,
c.status=a.status)});c(a.storyID,a.status,b,!0);a.storyID===estimate.cache.activeStory&&d(a.status)}})(story||(story={}));
...
function(){UIkit.util.on(".modal","show",b);UIkit.util.on(".modal","hide",e);d("welcome");d("session",session.onModalOpen);d("action",action.loadActions);d("comment",comment.load,comment.closeModal);d("self",member.viewSelf);d("invitation");d("member",member.viewActiveMember);d("add-story",story.viewAddStory);d("story",story.viewActiveStory);d("add-report",report.viewAddReport);d("report",report.viewReport);d("add-feedback",feedback.viewAddFeedback);d("feedback",feedback.viewFeedback)};a.open=c;a.openSoon=
function(a){setTimeout(function(){return c(a)},0)};a.hide=function(a){a=UIkit.modal("#modal-"+a);a.$el.classList.contains("uk-open")&&a.hide()}})(modal||(modal={}));var notify;(function(a){a.notify=function(a,c){UIkit.notification(a,{status:c?"success":"danger",pos:"top-right"})}})(notify||(notify={}));var style;
