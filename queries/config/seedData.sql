...
values
  ('00000000-0000-0000-0000-000000000000', 'System Admin', 'admin', 'light', 'bluegrey', 'bluegrey', '', 'en-US'),
  ('FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'Default User', 'guest', 'light', 'bluegrey', 'bluegrey', '', 'en-US')
;
...
values
  ('21000000-0000-0000-0000-000000000000', '20000000-0000-0000-0000-000000000000', '2020-05-08', '00000000-0000-0000-0000-000000000000', 'Report A', 'Report A'),
  ('21000001-0000-0000-0000-000000000000', '20000000-0000-0000-0000-000000000000', '2020-05-09', '00000000-0000-0000-0000-000000000000', 'Report B', 'Report B'),
  ('21000002-0000-0000-0000-000000000000', '20000000-0000-0000-0000-000000000000', '2020-05-09', 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'Report C', 'Report C'),
  ('21000003-0000-0000-0000-000000000000', '20000000-0000-0000-0000-000000000000', '2020-05-10', 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'Report D', 'Report D')
;
...
values
  ('31000000-0000-0000-0000-000000000000', '30000000-0000-0000-0000-000000000000', 0, '00000000-0000-0000-0000-000000000000', 'bad', 'Bad!', 'Bad!'),
  ('31000001-0000-0000-0000-000000000000', '30000000-0000-0000-0000-000000000000', 1, '00000000-0000-0000-0000-000000000000', 'good', 'Good A', 'Good A'),
  ('31000002-0000-0000-0000-000000000000', '30000000-0000-0000-0000-000000000000', 2, 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'good', 'Good B', 'Good B'),
  ('31000003-0000-0000-0000-000000000000', '30000000-0000-0000-0000-000000000000', 3, 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'improve', 'Improve stuff', 'Improve stuff')
;
...
values
  ('40000000-0000-0000-0000-000000000000', 'estimate', '10000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', 'todo', '{}', 'Action A'),
  ('40000001-0000-0000-0000-000000000000', 'estimate', '10000000-0000-0000-0000-000000000000', '00000000-0000-0000-0000-000000000000', 'todo', '{}', 'Action B'),
  ('40000002-0000-0000-0000-000000000000', 'standup', '20000000-0000-0000-0000-000000000000', 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'todo', '{}', 'Action C'),
  ('40000003-0000-0000-0000-000000000000', 'retro', '30000000-0000-0000-0000-000000000000', 'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF', 'todo', '{}', 'Action D')
;
