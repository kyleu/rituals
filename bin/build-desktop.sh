...
bin/build.sh windows amd64 rituals.exe
# bin/build-webview.sh windows amd64 rituals.exe

bin/build.sh windows 386 rituals.exe
bin/build.sh windows arm rituals.exe
# bin/build.sh windows arm64 rituals.exe
